...
selfAssessmentCharges.whatIsPaymentOnAccount.p4.linkText                      = Help i ddeall eich bil treth Hunanasesiad (yn agor tab newydd).
...
chargeSummary.reviewAndReconcilePoa.p.textOne                         = HMRC has created this charge because your
...
chargeSummary.reviewAndReconcilePoa.p.textTwo                         = ar gyfer blwyddyn dreth {0} i {1} yn rhy isel.
chargeSummary.reviewAndReconcilePoa.p.two                             = Efallai fod hyn oherwydd eich bod wedi addasu eich Ffurflen Dreth yn y flwyddyn flaenorol. Efallai fod hyn hefyd oherwydd eich bod wedi gostwng eich taliadau ar gyfrif i swm sy’n llai na’r hyn mae’ch Ffurflen Dreth yn nodi y dylech fod wedi’i dalu.
chargeSummary.whatIsPaymentOnAccount.linkText                         = Beth yw taliad ar gyfrif?
chargeSummary.whatIsPaymentOnAccount.p1                               = Mae ‘taliadau ar gyfrif’ yn dau daliad ymlaen llaw a wneir tuag at eich bil treth nesaf.
chargeSummary.whatIsPaymentOnAccount.p2                               = Mae CThEF yn amcangyfrif cyfanswm y bil yn seiliedig ar eich bil treth o’r flwyddyn flaenorol. Mae bob taliad yn hanner y swm hwnnw.
chargeSummary.whatIsPaymentOnAccount.p3                               = Os byddwch chi’n gwneud diwygiad i’r Ffurflen Dreth ac mae’r bil treth yn newid, yna bydd pob taliad ar gyfrif yn cael ei ddiweddaru i hanner y cyfanswm newydd.
chargeSummary.whatIsPaymentOnAccount.p4.linkText                      = Help i ddeall eich bil treth Hunanasesiad (yn agor tab newydd).
chargeSummary.interestOnThisCharge.heading                            = Llog ar y tâl hwn
chargeSummary.interestOnThisCharge.p1                                 = Caiff llog ei godi o ddyddiad dyledus gwreiddiol eich taliad cyntaf ar gyfrif.
chargeSummary.interestOnThisCharge.p2                                 = Bydd llog yn cael ei amcangyfrif hyd nes caiff y tâl cysylltiedig ei dalu’n llawn.
chargeSummary.interestOnThisCharge.Table.heading1                     = Cyfnod y llog
chargeSummary.interestOnThisCharge.Table.heading2.1                   = Cyfradd log
chargeSummary.interestOnThisCharge.Table.heading2.2                   = bresennol
chargeSummary.interestOnThisCharge.Table.heading3.1                   = Swm
chargeSummary.interestOnThisCharge.Table.heading3.2                   = amcangyfrifedig
chargeSummary.interestOnThisCharge.Table.totalText                    = Cyfanswm y llog ar y tâl hwn
chargeSummary.interestOnThisCharge.Table.percentage                   = 8%
chargeSummary.interestOnThisCharge.guidanceText                       = Gall llog ar dâl sydd arnoch fynd i fyny neu i lawr. Gweler yr arweiniad ar y gyfradd log a bennir gan CThEF
chargeSummary.interestOnThisCharge.guidanceLinkText                   = y gyfradd llog a bennir gan CThEF
chargeSummary.interestOnThisCharge.guidanceLinkText.dot               = .
chargeSummary.historyOfCharge.heading                                 = Hanes y tâl hwn
chargeSummary.historyOfCharge.Caption                                 = Mae’r tâl hwn yn mynd tuag at eich bil treth {0} i {1}
...
optout.taxYearQuestion.inset.currentYear.multiYear                     = Bydd diweddariadau chwarterol yr ydych wedi’u cyflwyno yn cael eu dileu o’n cofnodion os ydych yn optio allan o’r flwyddyn dreth honno. Bydd angen i chi gynnwys unrhyw incwm o’r diweddariadau hyn yn eich Ffurflen Dreth.
optout.taxYearQuestion.desc2.currentYear.multiYear                     = Byddai angen i chi fynd yn ôl i’r ffordd yr oeddech yn cyflwyno’ch Ffurflenni Treth yn y gorffennol ar gyfer pob un o’ch busnesau cyfredol, ac unrhyw fusnesau eraill y byddwch yn eu hychwanegu yn y dyfodol.
optout.taxYearQuestion.desc3.currentYear.multiYear                     = Yn y dyfodol, efallai y bydd angen i chi fynd yn ôl i ddefnyddio’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm. Os bydd hyn yn digwydd, byddwn yn ysgrifennu atoch i roi gwybod i chi.
...
optout.taxYearQuestion.desc1.nextYear.multiYear                        = O 6 Ebrill {0} ymlaen, byddai hyn yn golygu na fydd angen i chi ddefnyddio meddalwedd sy’n cydweddu â’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm mwyach.
optout.taxYearQuestion.desc2.nextYear.multiYear                        = Yn ogystal â hyn, bydd angen i chi fynd yn ôl i’r ffordd yr oeddech yn cyflwyno’ch Ffurflenni Treth yn y gorffennol ar gyfer pob un o’ch busnesau cyfredol, ac unrhyw fusnesau eraill y byddwch yn eu hychwanegu yn y dyfodol.
...
optout.taxYearQuestion.desc1.currentYear.multiYearCYFollowedByAnnual                     = O 6 Ebrill {0} ymlaen, byddai hyn yn golygu na fydd angen i chi ddefnyddio meddalwedd sy’n cydweddu â’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm mwyach.
optout.taxYearQuestion.desc2.currentYear.multiYearCYFollowedByAnnual                     = Yn ogystal â hyn, bydd angen i chi fynd yn ôl i’r ffordd yr oeddech yn cyflwyno’ch Ffurflenni Treth yn y gorffennol ar gyfer pob un o’ch busnesau cyfredol, ac unrhyw fusnesau eraill y byddwch yn eu hychwanegu yn y dyfodol.
optout.taxYearQuestion.desc3.currentYear.multiYearCYFollowedByAnnual                     = Yn y dyfodol, efallai y bydd angen i chi fynd yn ôl i ddefnyddio’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm. Os bydd hyn yn digwydd, byddwn yn ysgrifennu atoch i roi gwybod i chi.
...
yourSelfAssessmentChargeSummary.reviewAndReconcile.heading2.youOwe      = Mae arnoch: {0} (heb gynnwys llog wedi’i amcangyfrif)
