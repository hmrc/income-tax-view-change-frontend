...
tax.year.summary.calc.not.compatible.available.software.p          = Os cyflwynwyd eich Ffurflen Dreth gan ddefnyddio meddalwedd sy’n cydweddu â Throi Treth yn Ddigidol ar gyfer Treth Incwm, bydd eich cyfrifiad treth ar gael yn y feddalwedd hon.
tax.year.summary.calc.filed.by.post.contact.hmrc.p                 = Er mwyn bwrw golwg dros eich cyfrifiad treth os gwnaethoch gyflwyno’ch Ffurflen Dreth drwy’r post,
...
tax.year.summary.calc.not.filed.compatible.software.p1             = Mae hyn oherwydd na chafodd y Ffurflen Dreth ei chyflwyno gan ddefnyddio meddalwedd sy’n cydweddu â Throi Treth yn Ddigidol ar gyfer Treth Incwm.

tax.year.summary.calc.filed.sa.agent.p.a                           = Mae’n bosibl eich bod wedi cyflwyno’r Ffurflen Dreth gan ddefnyddio’ch cyfrif
tax.year.summary.calc.filed.sa.agent.link.a                        = Hunanasesiad ar gyfer Asiantau blaenorol
...
tax.year.summary.calc.not.compatible.available.software.agent.p    = Os cyflwynwyd y Ffurflen Dreth gan ddefnyddio meddalwedd sy’n cydweddu â Throi Treth yn Ddigidol ar gyfer Treth Incwm, bydd eich cyfrifiad treth ar gael yn y feddalwedd hon.
