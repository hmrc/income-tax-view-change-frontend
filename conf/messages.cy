...
reporting.frequency.latency.details.section.text.para1              = Ar gyfer blynyddoedd treth rydych yn defnyddio Troi Treth yn Ddigidol ar gyfer Treth Incwm, gallwch ddewis ar wahân i optio allan ar gyfer unrhyw ffynhonnell incwm o eiddo neu fasnachwr newydd:
...
reporting.frequency.latency.details.section.text.para2              = Mae’r opsiwn hwn ar gael i’ch busnesau newydd:
reporting.frequency.latency.details.section.text.para2.bullet1      = am hyd ar 2 flwyddyn dreth
reporting.frequency.latency.details.section.text.para2.bullet2      = dim ond pan fyddwch yn defnyddio Troi Treth yn Ddigidol ar gyfer Treth Incwm ar gyfer eich busnesau eraill
reporting.frequency.latency.details.section.text.para2.bullet3      = hyd yn oed os yw cyfanswm eich incwm gros o hunangyflogaeth neu eiddo, neu’r ddau, yn fwy na’r trothwy o £50,000
reporting.frequency.latency.details.section.text.para3.heading      = Sut i newid eich rhwymedigaethau adrodd ar gyfer ffynhonnell incwm newydd
reporting.frequency.latency.details.section.text.para3.text.1       = Gallwch wneud hyn ar unrhyw adeg o’r adran
reporting.frequency.latency.details.section.text.para3.link.text    = eich busnesau
