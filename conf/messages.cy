...
chargeSummary.chargeHistory.created.codingOut.text                      = Amount to be collected through your PAYE tax code in {0} to {1} tax year. (WELSH)
chargeSummary.chargeHistory.created.poa1CodedOut.text                   = Amount to be collected through your PAYE tax code in {0} to {1} tax year. (WELSH)
chargeSummary.chargeHistory.created.poa2CodedOut.text                   = Amount to be collected through your PAYE tax code in {0} to {1} tax year. (WELSH)
