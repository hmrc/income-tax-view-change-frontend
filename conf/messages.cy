...
tax-year-summary.calculation-example                               = Er enghraifft, ar gyfer blwyddyn dreth {0} i {1}, fel arfer bydd angen i chi wneud y newid ar-lein erbyn 31 Ionawr {2}.
tax-year-summary.calculation-contact-hmrc                          = Os yw’r dyddiad hwnnw wedi mynd heibio neu os na allwch ddiwygio’ch Ffurflen Dreth am reswm arall, bydd angen i chi gysylltu â CThEF.
