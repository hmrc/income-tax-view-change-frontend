...
tax-year-summary.agent.message.C15510                          = mi all y rhyddhad Rhentu Ystafell a hawliwyd ar gyfer eiddo sydd wedi’i osod ar y cyd fod yn fwy na {0}% o’r terfyn ar gyfer y cynllun Rhentu Ystafell.
tax-year-summary.agent.message.C15518                          = mae swm y rhyddhad Rhentu Ystafell a hawliwyd gan eich cleient yn uwch na’r terfyn.
...
whatYouOwe.hmrcAdjustment.heading                               = Addasiad CThEF
whatYouOwe.hmrcAdjustment.line1                                 = Mae’r taliad hwn wedi’i greu gan CThEF.
...
incomeSources.add.FP.AccountingMethod.heading                 = Pa ddull cyfrifyddu yr ydych yn ei ddefnyddio ar gyfer eich busnes eiddo tramor?
incomeSources.add.FP.AccountingMethod.example                 = Dangoswch enghraifft i mi
incomeSources.add.FP.AccountingMethod.radio-1-title           = Cyfrifyddu ar sail arian parod
...
incomeSources.add.SE.AccountingMethod.hint                    = Os oes gennych fwy nag un busnes unig fasnachwr, mae angen i’ch holl, fusnesau gael yr un dull cyfrifddu.
incomeSources.add.SE.AccountingMethod.example                 = Dangoswch enghraifft i mi
incomeSources.add.SE.AccountingMethod.radio-1-title           = Cyfrifyddu ar sail arian parod
incomeSources.add.SE.AccountingMethod.radio-1-hint            = Rydych yn cofnodi ar y dyddiad yr ydych yn cael arian neu’n talu bil. Mae’r rhan fwyaf o unig fasnachwyr a busnesau bach yn defnyddio’r dull hwn.
incomeSources.add.SE.AccountingMethod.radio-2-title           = Cyfrifyddu traddodiadol
incomeSources.add.SE.AccountingMethod.radio-2-hint            = Rydych yn cofnodi ar y dyddiad yr ydych yn anfon neu’n cael anfoneb, hyd yn oed os nad ydych yn cael nac yn talu unrhyw arian. Mae hyn hefyd yn cael ei alw’n gyfrifyddu ‘ar sail croniadau’ neu’n gyfrifyddu ‘safonol’.
...
incomeSources.add.UK.AccountingMethod.radio-1-title           = Cyfrifyddu ar sail arian parod
...
optin.completedOptIn.cy.revisedDeadlines.title      = TBD
optin.completedOptIn.cy.revisedDeadlines.p1.a       = Maei’n rhaid i chi gyflwyno’ch diweddariad chwarterol nesaf, ar gyfer blwyddyn dreth 2024 i 2025, erbyn
optin.completedOptIn.cy.revisedDeadlines.p1.b       = 5 Chwefror {0}
optin.completedOptIn.cy.revisedDeadlines.p1.c       = ar gyfer cyfnod chwarterol 6 Hydref {0} i 5 Ionawr {1}
optin.completedOptIn.cy.revisedDeadlines.p2.a       = Mae’n rhaid i chi gyflwyno’ch Ffurflen Dreth ar gyfer blwyddyn dreth {0} i {1} erbyn
optin.completedOptIn.cy.revisedDeadlines.p2.b       = 31 Ionawr {0}
optin.completedOptIn.cy.upcomingUpdates             = Bwrw golwg dros eich diweddariadau sydd ar y gweill
optin.completedOptIn.cy.reportingFrequency.a        = Gallwch, ar unrhyw adeg, optio allan o adrodd yn chwarterol ar gyfer pob un o’ch busnesau. Gallwch wneud hyn drwy fynd i’r dudalen ynghylch
optin.completedOptIn.cy.reportingFrequency.b        = amlder eich adroddiadau.
optin.completedOptIn.cy.reportingFrequency.c        =
optin.completedOptIn.cy.submitUpdates               = Cyflwyno diweddariadau drwy ddefnyddio meddalwedd
optin.completedOptIn.cy.submitUpdates.desc1.a       = Os ydych yn adrodd am flwyddyn dreth yn chwarterol, bydd angen i chi ddefnyddio
optin.completedOptIn.cy.submitUpdates.desc1.b       = meddalwedd sy’n cydweddu �’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm (yn agor tab newydd).
optin.completedOptIn.cy.submitUpdates.desc1.b.url   = https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax.cy
optin.completedOptIn.cy.futureReporting             = Adrodd yn y dyfodol
...
optin.completedOptIn.cy.futureReporting.p1          = mae CThEF yn gostwng y trothwy incwm ar gyfer Troi Treth yn Ddigidol ar gyfer Treth Incwm
optin.completedOptIn.cy.futureReporting.p2          = rydych yn adrodd am gynnydd yn eich incwm cymhwysol mewn Ffurflen Dreth
optin.completedOptIn.cy.futureReporting.scenario    = Er enghraifft, pe bai eich incwm o hunangyflogaeth neu eiddo, neu o’r ddau, yn uwch na’r trothwy ym mlwyddyn dreth {0} i {1}, byddai’n rhaid i chi gyflwyno adroddiadau’n chwarterol o 6 Ebrill {2} ymlaen.
optin.completedOptIn.cy.futureReporting.desc2       = Os bydd hyn yn digwydd, byddwn yn ysgrifennu atoch i roi gwybod i chi.
optin.completedOptIn.cy.incomeThreshold.desc.a      = Gallwch wirio’r trothwy ar gyfer incwm cymhwysol yn y
optin.completedOptIn.cy.incomeThreshold.desc.b      = meini prawf ar gyfer pobl y bydd angen iddynt gofrestru ar gyfer y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm (yn agor tab newydd).
optin.completedOptIn.cy.incomeThreshold.desc.b.url  = https://www.gov.uk/guidance/check-if-youre-eligible-for-making-tax-digital-for-income-tax.cy#pwy-fydd-angen-cofrestru

optin.completedOptIn.ny.heading.desc               = TBD
optin.completedOptIn.ny.nextUpdates                = Eich diweddariadau nesaf sy’n ddyledus
optin.completedOptIn.ny.nextUpdate.desc1.a         = Gwiriwch y dudalen ynghylch
optin.completedOptIn.ny.nextUpdate.desc1.b         = diweddariadau a dyddiadau cau
optin.completedOptIn.ny.nextUpdate.desc1.c         = er mwyn gweld dyddiadau cau’r flwyddyn dreth bresennol. Ni fydd dyddiadau cau ar gyfer blynyddoedd yn y dyfodol i’w gweld hyd nes eu bod yn dod yn rhan o’r flwyddyn sydd ohoni.
optin.completedOptIn.ny.nextUpdate.desc2.a         = TBD
optin.completedOptIn.ny.nextUpdate.desc2.b         = TBD
optin.completedOptIn.ny.nextUpdate.desc2.c         = TBD
optin.completedOptIn.ny.submitUpdates              = Cyflwyno diweddariadau drwy ddefnyddio meddalwedd
optin.completedOptIn.ny.submitUpdates.desc1.a      = Os ydych yn adrodd am flwyddyn dreth yn chwarterol, bydd angen i chi ddefnyddio
optin.completedOptIn.ny.submitUpdates.desc1.b      = meddalwedd sy’n cydweddu �’r cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm (yn agor tab newydd).
optin.completedOptIn.ny.submitUpdates.desc1.b.url  = https://www.gov.uk/guidance/find-software-thats-compatible-with-making-tax-digital-for-income-tax.cy
...
optin.completedOptIn.ny.futureReporting            = Adrodd yn y dyfodol
...
optin.completedOptIn.ny.futureReporting.p1         = mae CThEF yn gostwng y trothwy incwm ar gyfer Troi Treth yn Ddigidol ar gyfer Treth Incwm
optin.completedOptIn.ny.futureReporting.p2         = rydych yn adrodd am gynnydd yn eich incwm cymhwysol mewn Ffurflen Dret
optin.completedOptIn.ny.futureReporting.scenario   = Er enghraifft, pe bai eich incwm o hunangyflogaeth neu eiddo, neu o’r ddau, yn uwch na’r trothwy ym mlwyddyn dreth {0} i {1}, byddai’n rhaid i chi gyflwyno adroddiadau’n chwarterol o 6 Ebrill {2} ymlaen.
optin.completedOptIn.ny.futureReporting.desc2      = Os bydd hyn yn digwydd, byddwn yn ysgrifennu atoch i roi gwybod i chi.
optin.completedOptIn.ny.incomeThreshold.desc.a     = Gallwch wirio?r trothwy ar gyfer incwm cymhwysol yn y
optin.completedOptIn.ny.incomeThreshold.desc.b     = meini prawf ar gyfer pobl y bydd angen iddynt gofrestru ar gyfer y cynllun Troi Treth yn Ddigidol ar gyfer Treth Incwm (yn agor tab newydd).
optin.completedOptIn.ny.incomeThreshold.desc.b.url = https://www.gov.uk/guidance/check-if-youre-eligible-for-making-tax-digital-for-income-tax.cy#pwy-fydd-angen-cofrestru
