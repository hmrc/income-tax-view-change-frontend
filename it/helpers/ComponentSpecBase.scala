...
trait ComponentSpecBase extends TestSuite with CustomMatchers
  ...
  object IncomeTaxViewChangeFrontend {
    ...
    def getAddBusinessObligations(session: Map[String, String]): WSResponse = {
      getWithClientDetailsInSession("/income-sources/add/business-added", session)
    }
    ...
    def getConfirmForeignPropertyReportingMethod(taxYear: String, changeTo: String): WSResponse = {
      get(s"/income-sources/manage/confirm-you-want-to-report-foreign-property?taxYear=$taxYear&changeTo=$changeTo")
    }
    ...
    def postAddBusinessReportingMethod(form: AddBusinessReportingMethodForm)(additionalCookies: Map[String, String] = Map.empty): WSResponse = {
      ...
      post(s"/income-sources/add/business-reporting-method", additionalCookies = additionalCookies)(formData)
    }
