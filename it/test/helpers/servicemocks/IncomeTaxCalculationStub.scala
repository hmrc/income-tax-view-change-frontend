...
object IncomeTaxCalculationStub {
  ...
  def getCalculationResponseUrl(nino: String, taxYear: String): String =
  ...
  def stubGetCalculationResponse(
      nino:    String,
      taxYear: String
    )(
      status: Int,
      body:   LiabilityCalculationResponse
    ): Unit = {
    WiremockHelper.stubGet(getCalculationResponseUrl(nino, taxYear), status, Json.toJson(body).toString())
  }

  def stubGetCalculationErrorResponse(
      nino:    String,
      taxYear: String
    )(
      status: Int,
      body:   LiabilityCalculationError
    ): Unit = {
    WiremockHelper.stubGet(getCalculationResponseUrl(nino, taxYear), status, Json.toJson(body).toString())
  }
  ...
  def stubGetCalculationResponseByCalcId(
      nino:    String,
      taxYear: Int,
      calcId:  String
    )(
    ...
    WiremockHelper.stubGet(
      getCalculationResponseByCalcIdUrl(nino, calcId, taxYear),
      status,
      Json.toJson(body).toString()
    )
  }

  def stubGetCalculationErrorResponseByCalcId(
      nino:    String,
      calcId:  String,
      taxYear: Int
    )(
  ...
  def verifyGetCalculationResponseByCalcId(
      nino:      String,
      calcId:    String,
      taxYear:   Int,
      noOfCalls: Int = 1
