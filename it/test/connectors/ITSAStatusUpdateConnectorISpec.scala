    ...
    ".makeITSAStatusUpdate()" when {
      ...
      "request body" should {
        ...
        "be built correctly for OptInReason" in {
          ...
          WiremockHelper.stubPut(s"/income-tax-obligations/itsa-status/update/$taxableEntityId", NO_CONTENT, correctOptIntRequestBody, "{}")
      ...
      "handle errors" when {
        ...
        "not NO_CONTENT" should {
          ...
          "return a error response with status INTERNAL_SERVER_ERROR" in {
            ...
            WiremockHelper.stubPut(s"/income-tax-obligations/itsa-status/update/$taxableEntityId", OK, correctOptIntRequestBody, "{}")
        ...
        "status is BAD_REQUEST" when {
          ...
          "with INVALID_PAYLOAD" in {
            ...
            WiremockHelper.stubPut(s"/income-tax-obligations/itsa-status/update/$taxableEntityId", BAD_REQUEST, correctOptIntRequestBody, invalidPayLoadFailureResponseBody)
