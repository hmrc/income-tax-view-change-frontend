            ...
            if (mtdUserRole == MTDSupportingAgent) {
              ...
              "render the charge summary page" that {
                  ...
                  "Charge History feature is disabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                      ...
                      testValidFinancialDetailsModelJson(
                        ...
                        interestLocks = twoInterestLocks
                      )
                    )
                    IncomeTaxViewChangeStub.stubChargeHistoryResponse(testNino, "ABCD1234")(
                      OK,
                      testChargeHistoryJson(testNino, "ABCD1234", 2500)
                    )
                ...
                "includes the importantPaymentBreakdown" when {
                  "Charge History feature is disabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                      OK,
                      testAuditFinancialDetailsModelJson(
                        123.45,
                        1.2,
                    ...
                    AuditStub.verifyAuditEvent(
                      ChargeSummaryAudit(
                        testUser(mtdUserRole),
                        chargeItemWithInterestAndOverdue(
                          BalancingCharge,
                          None,
                  ...
                  "when charge history is enabled" in {
                    ...
                    val json = testAuditFinancialDetailsModelJson(
                      123.45,
                      1.2,
                      dunningLock = oneDunningLock,
                      interestLocks = twoInterestLocks,
                    ...
                    val x = chargeItemWithInterestAndOverdue(
                      BalancingCharge,
                      None,
                      Some(dateService.getCurrentDate.plusDays(20))
                    )
                ...
                "includes late payment interest" when {
                  "late payment interest flag is true and chargeHistory FS is enabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                      OK,
                      testValidFinancialDetailsModelJsonAccruingInterest(
                        123.45,
                        1.2,
                    ...
                    val res =
                      buildGETMTDClient(path + "?id=1040000123&isInterestCharge=true", additionalCookies).futureValue
                  ...
                  "late payment interest flag is true and chargeHistory FS is disabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                      OK,
                      testValidFinancialDetailsModelWithPaymentAllocationJson(10.34, 1.2)
                    )
                ...
                "is expected" when {
                  "late payment interest flag is true but there are no payment allocations" in {
                    ...
                    val res =
                      buildGETMTDClient(path + "?id=1040001234&isInterestCharge=true", additionalCookies).futureValue
                ...
                "has coding out details" when {
                  "coding out is enabled and a coded out documentDetail id is passed" in {
                    ...
                    res should have(
                      ...
                      elementTextBySelector("#coding-out-message")(
                        codingOutMessageWithStringMessagesArgument(2017, 2018)
                      )
                    )
                  }
                }
                ...
                "has balancing payment title" when {
                  s"ChargeHistory FS is enabled and the charge history details API responds with a $NOT_FOUND" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                      OK,
                      testValidFinancialDetailsModelJson(10.34, 1.2)
                    )
                    IncomeTaxViewChangeStub.stubChargeHistoryResponse(testNino, "ABCD1234")(
                      NOT_FOUND,
                      Json.parse("""
              ...
              "return a technical difficulties page to the user" when {
                ...
                "When Original Amount value is missing from financial details / document details" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                    OK,
                    testFinancialDetailsModelWithMissingOriginalAmountJson()
                  )
