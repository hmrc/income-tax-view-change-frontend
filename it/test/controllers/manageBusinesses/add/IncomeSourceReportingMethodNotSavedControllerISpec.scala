...
class IncomeSourceReportingMethodNotSavedControllerISpec extends ComponentSpecBase {
  ...
  val selfEmploymentReportingMethodNotSavedShowUrl: String = controllers.manageBusinesses.add.routes.IncomeSourceReportingMethodNotSavedController.show(SelfEmployment).url
  val ukPropertyReportingMethodNotSavedShowUrl: String = controllers.manageBusinesses.add.routes.IncomeSourceReportingMethodNotSavedController.show(UkProperty).url
  val foreignPropertyReportingMethodNotSavedShowUrl: String = controllers.manageBusinesses.add.routes.IncomeSourceReportingMethodNotSavedController.show(ForeignProperty).url
  ...
  s"calling GET $selfEmploymentReportingMethodNotSavedShowUrl" should {
    "render the reporting method not saved page" when {
      "User is authorised" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses.getSEReportingMethodNotSaved(Map.empty)
  ...
  s"calling GET $ukPropertyReportingMethodNotSavedShowUrl" should {
    "render the reporting method not saved page" when {
      "User is authorised" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses.getUkPropertyReportingMethodNotSaved(Map.empty)
        verifyIncomeSourceDetailsCall(testMtditid)
  ...
  s"calling GET $foreignPropertyReportingMethodNotSavedShowUrl" should {
    "render the reporting method not saved page" when {
      "User is authorised" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses.getForeignPropertyReportingMethodNotSaved(Map.empty)
        verifyIncomeSourceDetailsCall(testMtditid)
