    ...
    "render the self employment business not added error page" when {
      "Income Sources FS is enabled" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses
          .get("/manage-your-businesses/add/cannot-go-back-business-reporting-method")
  ...
  s"calling GET $ukPropertyBackErrorUrl" should {
    "render the self employment business not added error page" when {
      "Income Sources FS is enabled" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses
          .get("/manage-your-businesses/add/cannot-go-back-uk-property-reporting-method")
    ...
    "Income Sources FS is disabled" in {
      ...
      val result = IncomeTaxViewChangeFrontendManageBusinesses
        .get(s"/manage-your-businesses/add/cannot-go-back-uk-property-reporting-method")
  ...
  s"calling GET $foreignPropertyBackErrorUrl" should {
    "render the self employment business not added error page" when {
      "Income Sources FS is enabled" in {
        ...
        val result = IncomeTaxViewChangeFrontendManageBusinesses
          .get(s"/manage-your-businesses/add/cannot-go-back-foreign-property-reporting-method")
