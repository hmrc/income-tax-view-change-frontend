...
class ManageIncomeSourceControllerISpec extends ComponentSpecBase {
  ...
  val showIndividualViewIncomeSourceControllerUrl: String = controllers.manageBusinesses.manage.routes.ManageIncomeSourceController.show(false).url
  ...
  s"calling GET ${showIndividualViewIncomeSourceControllerUrl}" should {
    "render the View Income Source page for an Individual" when {
      "User is authorised" in {
        ...
        val res = IncomeTaxViewChangeFrontendManageBusinesses.getManageIncomeSource
