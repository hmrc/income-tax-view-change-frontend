                ...
                "has additional charges, student and graduate payment plan" in {
                  ...
                  verifyAuditEvent(
                    TaxDueResponseAuditModel(
                      ...
                      TaxDueSummaryViewModel(liabilityCalculationModelSuccessful),
                      testYearInt
                    )
                  )
                  ...
                  "the flag is missing from the calc data" in {
                    ...
                    res should have(
                      ...
                      elementTextBySelector(
                        "#national-insurance-contributions-table tbody:nth-child(3) td:nth-child(1)"
                      )(nonVoluntaryClass2Nics)
                    )
                  }
                }
