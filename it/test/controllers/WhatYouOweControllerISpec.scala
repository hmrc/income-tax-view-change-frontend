...
class WhatYouOweControllerISpec extends ControllerISpecHelper with ChargeConstants with TransactionUtils {
  ...
  val testValidOutStandingChargeResponseJsonWithAciAndBcdCharges: JsValue = Json.parse(s"""
       |{
       |  "outstandingCharges": [{
       |         "chargeName": "BCD",
              ...
              "render the what you owe page" which {
                "displays the payments due totals" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                    ...
                    OK,
                    testValidFinancialDetailsModelJsonCodingOut(
                      2000,
                      2000,
                      (testTaxYear - 1).toString,
                      testDate.plusYears(1).toString
                    )
                  )
                  ...
                  AuditStub.verifyAuditContainsDetail(
                    WhatYouOweResponseAuditModel(
                      testUser(mtdUserRole),
                      whatYouOweFinancialDetailsEmptyBCDCharge,
                      testDateService
                    ).detail
                  )
                  ...
                  IncomeTaxViewChangeStub.verifyGetOutstandingChargesResponse(
                    "utr",
                    testSaUtr.toLong,
                    (testTaxYear - 1).toString
                  )
                ...
                "has a multiple charge from financial details and BCD and ACI charges from CESA" in {
                  ...
                  AuditStub.verifyAuditContainsDetail(
                    WhatYouOweResponseAuditModel(
                      testUser(mtdUserRole),
                      whatYouOweDataWithDataDueIn30DaysIt,
                      dateService
                    ).detail
                  )
                ...
                "has a multiple charge, without BCD and ACI charges from CESA" in {
                  ...
                  val financialDetailsResponseJson = testValidFinancialDetailsModelJson(
                    2000,
                    2000,
                    testTaxYear.toString,
                    testDate.minusDays(15).toString
                  )
                  ...
                  val whatYouOweChargesList = {
                    val documentDetailsForTestTaxYear =
                      financialDetailsModel.documentDetailsFilterByTaxYear(testTaxYear)
                  ...
                  AuditStub.verifyAuditEvent(
                    WhatYouOweResponseAuditModel(testUser(mtdUserRole), whatYouOweChargesList, dateService)
                  )
                ...
                "has multiple charges and one charge equals zero" in {
                  ...
                  val mixedJson = Json.obj(
                    "balanceDetails" -> Json
                      .obj("balanceDueWithin30Days" -> 1.00, "overDueAmount" -> 2.00, "totalBalance" -> 3.00),
                    "documentDetails" -> Json.arr(
                      ...
                      documentDetailJson(
                        ...
                        dueDate = testDate.plusDays(1).toString
                      ),
                      documentDetailJson(
                        1000.00,
                        0.00,
                        ...
                        dueDate = testDate.minusDays(1).toString
                      )
                    ),
                    "financialDetails" -> Json.arr(
                      ...
                      financialDetailJson(
                        (testTaxYear - 1).toString,
                        "SA Payment on Account 1",
                        "4920",
                        testDate.plusDays(1).toString,
                        "transId2"
                      ),
                      financialDetailJson(
                        (testTaxYear - 1).toString,
                        "SA Payment on Account 2",
                        "4930",
                        testDate.minusDays(1).toString,
                        "transId3"
                      )
                    )
                  )
                  ...
                  AuditStub.verifyAuditContainsDetail(
                    WhatYouOweResponseAuditModel(
                      testUser(mtdUserRole),
                      whatYouOweWithAZeroOutstandingAmount(),
                      dateService
                    ).detail
                  )
                ...
                "no charge" when {
                  "YearOfMigration does not exists" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetIncomeSourceDetailsResponse(testMtditid)(
                      OK,
                      propertyOnlyResponseWithMigrationData(testTaxYear - 1, None)
                    )
                    ...
                    AuditStub.verifyAuditContainsDetail(
                      WhatYouOweResponseAuditModel(testUser(mtdUserRole), whatYouOweNoChargeList, dateService).detail
                    )
                    ...
                    res should have(
                      ...
                      pageTitle(
                        mtdUserRole,
                        s"whatYouOwe.heading${if (mtdUserRole != MTDIndividual) "-agent" else ""}"
                      ),
                      isElementVisibleById("balancing-charge-type-0")(expectedValue = false),
                      isElementVisibleById("balancing-charge-type-1")(expectedValue = false),
                ...
                "has ACI and BCD charge" when {
                  ...
                  "YearOfMigration exists with Invalid financial details charges and valid outstanding charges" in {
                    ...
                    AuditStub.verifyAuditContainsDetail(
                      WhatYouOweResponseAuditModel(
                        testUser(mtdUserRole),
                        whatYouOweOutstandingChargesOnly,
                        dateService
                      ).detail
                    )
                  ...
                  "CodingOut FS is enabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                      ...
                      testValidFinancialDetailsModelJsonCodingOut(
                        ...
                        testDate.toString,
                        0,
                        (getCurrentTaxYearEnd.getYear - 1).toString,
                        2000
                      )
                    )
                    IncomeTaxViewChangeStub.stubGetOutstandingChargesResponse(
                ...
                "has a multiple charges ~ TxM extension" in {
                  ...
                  AuditStub.verifyAuditContainsDetail(
                    WhatYouOweResponseAuditModel(
                      testUser(mtdUserRole),
                      whatYouOweDataWithDataDueInSomeDays,
                      dateService
                    ).detail
                  )
                ...
                "has MFA Debits on the Payment Tab" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                    ...
                    OK,
                    testValidFinancialDetailsModelMFADebitsJson(
                      2000,
                      2000,
                      testTaxYear.toString,
                      testDate.plusYears(1).toString
                ...
                "has a POA section" when {
                  "AdjustPaymentsOnAccount FS is enabled and a user" that {
                    "has valid POAs" in {
                      ...
                      IncomeTaxViewChangeStub.stubGetIncomeSourceDetailsResponse(testMtditid)(
                        OK,
                        propertyOnlyResponseWithMigrationData(testTaxYearPoa - 1, Some(testTaxYearPoa.toString))
                      )
                      IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                        testNino,
                    ...
                    "has available credits" in {
                      ...
                      res should have(
                        ...
                        elementTextBySelector("#money-in-your-account")(
                          messagesAPI(
                            s"whatYouOwe.moneyOnAccount${if (mtdUserRole != MTDIndividual) "-agent" else ""}"
                          ) + " " +
                            messagesAPI("whatYouOwe.moneyOnAccount-1") + " £300.00" + " " +
                            messagesAPI(
                              s"whatYouOwe.moneyOnAccount${if (mtdUserRole != MTDIndividual) "-agent" else ""}-2"
                            ) + " " +
              ...
              "render the internal server error page" when {
                ...
                "Outstanding charges connector return internal server error" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                    ...
                    s"${testTaxYear - 1}-04-06",
                    s"$testTaxYear-04-05"
                  )(OK, testValidFinancialDetailsModelJson(2000, 2000, testTaxYear.toString, testDate.toString))
                  IncomeTaxViewChangeStub.stubGetOutstandingChargesResponse(
                    "utr",
                    testSaUtr.toLong,
                    (testTaxYear - 1).toString
