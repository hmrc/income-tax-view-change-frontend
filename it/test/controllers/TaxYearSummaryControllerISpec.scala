              ...
              "render the tax summary page" that {
                "includes the forecast calculation tab" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetIncomeSourceDetailsResponse(testMtditid)(
                    OK,
                    singleBusinessResponseWoMigration
                  )
                  ...
                  val tableText =
                    "Forecast Section Amount Income £12,500.00 Allowances and deductions £4,200.00 Total income on which tax is due £12,500.00 " +
                      "Forecast Self Assessment tax amount £5,000.99"
                  val forecastTabHeader = messagesAPI("tax-year-summary.forecast")
                  val forecastTotal =
                    s"${messagesAPI("tax-year-summary.forecast_total_title", (getCurrentTaxYearEnd.getYear - 1).toString, getCurrentTaxYearEnd.getYear.toString)} £5,000.99"
                  res should have(
                    httpStatus(OK),
                ...
                "that includes updates" in {
                  ...
                  allObligations.obligations.foreach { obligation =>
                  ...
                  res should have(
                    ...
                    pageTitle(mtdUserRole, "tax-year-summary.heading"),
                    elementTextBySelector("#calculation-date")("15 February 2019"),
                    elementTextBySelector(
                      "#income-deductions-contributions-table tr:nth-child(1) td[class=govuk-table__cell govuk-table__cell--numeric]"
                    )("£12,500.00"),
                    elementTextBySelector(
                      "#income-deductions-contributions-table tr:nth-child(2) td[class=govuk-table__cell govuk-table__cell--numeric]"
                    )("£12,500.00"),
                    elementTextBySelectorList(
                      "#income-deductions-contributions-table",
                      "tbody",
                      "tr:nth-child(4)",
                      "td:nth-of-type(1)"
                    )("£90,500.99"),
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "th")(s"$overdue $poa1"),
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(1)")(
                      "23 Apr 2021"
                    ),
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(2)")(
                      "£1,000.00"
                    ),
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(2)", "a")(poa1Lpi),
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(2)", "td:nth-of-type(1)")(
                      "24 Jun 2021"
                    ),
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(2)", "td:nth-of-type(2)")(
                      "£100.00"
                    ),
                    elementTextBySelectorList(
                      "#updates",
                    ...
                    elementTextBySelectorList(
                      ...
                      "tr:nth-of-type(1)",
                      "td:nth-of-type(2)"
                    )("5 Apr " + getCurrentTaxYearEnd.getYear.toString),
                    elementTextBySelectorList(
                      "#updates",
                      "div:nth-of-type(1)",
                      "table:eq(1) tbody",
                ...
                "has payments with and without dunning locks in the payments tab" in {
                  ...
                  res should have(
                    ...
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "th")(
                      s"$overdue $poa1 $underReview"
                    ),
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(1)")(
                      "23 Apr 2021"
                    ),
                    ...
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(3)", "th")(
                      s"$poa1Lpi $underReview"
                    ),
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(3)", "td:nth-of-type(1)")(
                      "24 Jun 2021"
                    ),
                    elementTextBySelectorList("#payments", "table", "tr:nth-of-type(3)", "td:nth-of-type(2)")(
                      "£100.00"
                    ),
                    elementTextBySelectorList(
                      "#updates",
                  ...
                  AuditStub.verifyAuditEvent(
                    TaxYearSummaryResponseAuditModel(
                      ...
                      TaxYearSummaryViewModel(
                        Some(CalculationSummary(liabilityCalculationModelSuccessfulExpected)),
                ...
                "has Coding out that has been accepted and rejected by NPS part way through the year" in {
                  ...
                  res should have(
                    ...
                    elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(2)", "th")(
                      s"$overdue $cancelledPayeSA"
                    )
                  )
                }
                ...
                "has expected content" when {
                  ...
                  "the user has the coding out requested amount has not been fully collected (partially collected)" in {
                    ...
                    IncomeTaxCalculationStub.stubGetCalculationResponse(
                      testNino,
                    ...
                    IncomeTaxViewChangeStub.verifyGetIncomeSourceDetails(testMtditid)
                    IncomeTaxCalculationStub.verifyGetCalculationResponse(
                      testNino,
                      getCurrentTaxYearEnd.getYear.toString
                    )
                    IncomeTaxViewChangeStub.verifyGetFinancialDetailsByDateRange(
                    ...
                    IncomeTaxViewChangeStub.verifyGetFinancialDetailsByDateRange(
                      testNino,
                      getCurrentTaxYearEnd.minusYears(1).plusDays(1).toString,
                  ...
                  "retrieving a calculation failed" in {
                    ...
                    IncomeTaxCalculationStub.stubGetCalculationErrorResponse(testNino, "2018")(
                      NO_CONTENT,
                      LiabilityCalculationError(NO_CONTENT, "error")
                    )
                    IncomeTaxViewChangeStub.stubGetAllObligations(
                      testNino,
                  ...
                  "calculation response contain error messages" in {
                    ...
                    val errMessages =
                      liabilityCalculationModelErrorMessagesFormatted(mtdUserRole).messages.get.errorMessages
                    ...
                    res should have(
                      ...
                      elementTextBySelectorList("#taxCalculation", "div h2")(
                        messagesAPI("tax-year-summary.message.header")
                      ),
                      elementTextBySelectorList("#taxCalculation", "div strong")(
                        "Warning " + messagesAPI(
                          s"tax-year-summary${if (mtdUserRole == MTDIndividual) "" else ".agent"}.message.action"
                        )
                      ),
                ...
                "MFA Debits on the Payment Tab with FS ENABLED" in {
                  ...
                  verifyAuditEvent(
                    TaxYearSummaryResponseAuditModel(
                      ...
                      TaxYearSummaryViewModel(
                        ...
                        auditDD
                          .map(dd =>
                            ChargeItem.fromDocumentPair(dd.documentDetail, financialDetailsMFADebits.financialDetails)
                          )
                  ...
                  result should have(
                    ...
                    pageTitle(mtdUserRole, "tax-year-summary.heading"),
                    elementTextBySelector("#calculation-date")("15 February 2019"),
                    elementTextBySelectorList("#payments-table", "tbody", "tr:nth-of-type(1)", "th")(
                      s"$hmrcAdjustment"
                    ),
                    elementTextBySelectorList("#payments-table", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(1)")(
                      "22 Apr 2021"
                    ),
                    elementTextBySelectorList("#payments-table", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(2)")(
                      "£2,234.00"
                    ),
                ...
                "that has the charges table" when {
                  "the user has Review and Reconcile debit charges and ReviewAndReconcilePoa FS is enabled" in {
                    ...
                    IncomeTaxCalculationStub.stubGetCalculationResponse(
                      testNino,
                      getCurrentTaxYearEnd.getYear.toString
                    )(status = OK, body = liabilityCalculationModelDeductionsMinimal)
                    CalculationListStub.stubGetCalculationList(testNino, "22-23")(
                      successResponseNonCrystallised.toString
                    )
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                      testNino,
                      s"${testYear2023 - 1}-04-06",
                      s"$testYear2023-04-05"
                    )(
                      OK,
                      testValidFinancialDetailsModelReviewAndReconcileDebitsJson(
                        2000,
                        2000,
                        testYear2023.toString,
                        futureDate.toString
                      )
                    )
                    ...
                    def getChargeSummaryUrl(id: String) =
                    ...
                    res should have(
                      httpStatus(OK),
                      pageTitle(mtdUserRole, "tax-year-summary.heading"),
                      elementTextByID("paymentTypeLink-0")(
                        "First payment on account: extra amount from your tax return"
                      ),
                      elementTextByID("paymentTypeLink-1")(
                        "Second payment on account: extra amount from your tax return"
                      ),
                ...
                "adjust POA link visible" when {
                  "The user has amendable POAs for the given tax year and the FS is Enabled" in {
                    ...
                    IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(
                      ...
                      s"${testYear2023 - 1}-04-06",
                      s"$testYear2023-04-05"
                    )(OK, testValidFinancialDetailsModelJson(2000, 2000, testYear2023.toString, testDate.toString))
              ...
              "render the error page" when {
                "financial details service returns an error" in {
                  ...
                  IncomeTaxViewChangeStub.stubGetFinancialDetailsByDateRange(testNino)(
                    ...
                    testFinancialDetailsErrorModelJson()
                  )
                ...
                "retrieving a getAllObligations error" in {
                  ...
                  IncomeTaxViewChangeStub.verifyGetFinancialDetailsByDateRange(
                    testNino,
                    LocalDate.of(2017, 4, 6).toString,
                ...
                "retrieving a calculation failed" in {
                  ...
                  IncomeTaxViewChangeStub.verifyGetIncomeSourceDetails(testMtditid)
                  IncomeTaxViewChangeStub.verifyGetAllObligations(
                    testNino,
                    LocalDate.of(2017, 4, 6),
                    LocalDate.of(2018, 4, 5)
                  )
