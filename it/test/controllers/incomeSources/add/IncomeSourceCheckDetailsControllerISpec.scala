...
class IncomeSourceCheckDetailsControllerISpec extends ControllerISpecHelper {
  ...
  val pathSE = "/income-sources/add/business-check-details"
  val pathUKProperty = "/income-sources/add/uk-property-check-details"
  val pathForeignProperty = "/income-sources/add/foreign-property-check-details"
