                  ...
                  incomeSourceType match {
                    case SelfEmployment =>
                      result should have(
                        ...
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(2) dd:nth-of-type(1)")(
                          "1 January 2023"
                        ),
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(3) dd:nth-of-type(1)")(
                          testBusinessTrade
                        ),
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(4) dd:nth-of-type(1)")(
                          testBusinessAddressLine1 + " " + testBusinessPostCode + " " + testBusinessCountryCodeView
                        ),
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(5) dd:nth-of-type(1)")(
                          testBusinessAccountingMethodView
                        ),
                    ...
                    case UkProperty =>
                      result should have(
                        ...
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(1) dd:nth-of-type(1)")(
                          "1 January 2023"
                        ),
                        elementTextBySelector("dl:nth-of-type(1) div:nth-of-type(2) dd:nth-of-type(1)")(
                          testBusinessAccountingMethodView
              ...
              "redirect to IncomeSourceReportingMethodController" when {
                "user selects 'confirm and continue'" in {
                    ...
                    case SelfEmployment =>
                      AuditStub.verifyAuditContainsDetail(
                        CreateIncomeSourceAuditModel(
                          ...
                          None,
                          None,
                          Some(CreateIncomeSourceResponse(testSelfEmploymentId))
                  ...
                  result should have(
                    ...
                    redirectURI(
                      controllers.incomeSources.add.routes.IncomeSourceReportingMethodController
                        .show(isAgent = mtdUserRole != MTDIndividual, incomeSourceType)
                        .url
                    )
                  )
                }
                ...
                "user session has no details" in {
                  ...
                  await(
                    sessionService.setMongoData(
                      emptyUIJourneySessionData(IncomeSourceJourneyType(Add, incomeSourceType))
                    )
                  )
