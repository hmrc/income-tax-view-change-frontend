...
class ReportingFrequencyControllerISpec extends ControllerISpecHelper {
  ...
  def stubCalculationListResponseBody(taxYearEnd: String) = {
    ...
    WiremockHelper.stubGet(
      s"/income-tax-view-change/list-of-calculation-results/$testNino/$taxYearEnd",
      OK,
      responseBody
    )
  }
              ...
              "just has generic link for opt out" when {
                "CY is Quaterly and CY+1 is Quaterly" in {
                  ...
                  result should have(
                    ...
                    elementTextByID("manage-reporting-frequency-heading")(
                      "Manage your reporting frequency for all your businesses"
                    ),
                    elementTextBySelector(optInOptOutLinks(1))("Opt out of quarterly reporting and report annually")
                  )
                  result shouldNot have(
                    elementTextBySelector(latencyDetailsHeader)(
                      "Your new businesses can have a different reporting frequency"
                    )
                  )
                }
              }
              ...
              "has tax year link for opt out and onwards link for opt in" when {
                "CY is Quaterly and CY+1 is Annual" in {
                  ...
                  result should have(
                    ...
                    elementTextBySelector(optInOptOutLinks(1))(
                      s"Opt out of quarterly reporting and report annually for the $currentStartYear to $currentEndYear tax year"
                    ),
                    elementTextBySelector(optInOptOutLinks(2))(
                      s"Opt in to quarterly reporting from the $nextStartYear to $nextEndYear tax year onwards"
                    )
                  )
                  result shouldNot have(
                    elementTextBySelector(latencyDetailsHeader)(
              ...
              "has tax year link for opt in and onwards link for opt out" when {
                "CY is Annual and CY+1 is Quaterly" in {
                  ...
                  result should have(
                    ...
                    elementTextBySelector(optInOptOutLinks(1))(
                      s"Opt in to quarterly reporting for the $currentStartYear to $currentEndYear tax year"
                    ),
                    elementTextBySelector(optInOptOutLinks(2))(
                      s"Opt out of quarterly reporting and report annually from the $nextStartYear to $nextEndYear tax year onwards"
                    )
                  )
                  result shouldNot have(
                    elementTextBySelector(latencyDetailsHeader)(
              ...
              "has tax year link for opt out and generic link for opt in" when {
                "CY-1 is Quaterly, CY is Annual and CY+1 is Annual" in {
                  ...
                  result should have(
                    ...
                    elementTextBySelector(optInOptOutLinks(1))(
                      s"Opt out of quarterly reporting and report annually for the $previousStartYear to $previousEndYear tax year"
                    ),
              ...
              "have latency related information section" when {
                "any of the business is latent" in {
                  ...
                  result should have(
                    ...
                    elementTextByID("rf-latency-para1")(
                      "For tax years you report quarterly, you can separately choose to report annually for any new sole trader or property income source:"
                    ),
                    ...
                    elementTextByID("rf-latency-para2-bullet2")(
                      "only when you report quarterly for your other businesses"
                    ),
                    elementTextByID("rf-latency-para2-bullet3")(
                      "even if your income from self-employment or property, or both, exceeds the income threshold"
                    ),
                    elementTextByID("rf-latency-small-heading")(
                      "How to change a new income source’s reporting frequency"
                    ),
                    elementTextByID("rf-latency-para3-text")(
                      "You can do this at any time in the all businesses section"
                    )
                  )

                  if (mtdUserRole == MTDIndividual) {
                    result should have(
                      elementAttributeBySelector(latencyDetailsLink, "href")(
                    ...
                    result should have(
                      elementAttributeBySelector(latencyDetailsLink, "href")(
                        "/report-quarterly/income-and-expenses/view/agents/manage-your-businesses"
                      )
                    )
                  }
                }
