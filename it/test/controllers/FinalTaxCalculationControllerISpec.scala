...
class FinalTaxCalculationControllerISpec extends ControllerISpecHelper {
  ...
  object ExpectedValues {
    ...
    val yourOrYourClients: Boolean => String = isAgent =>
      if (isAgent) {
        "your client’s"
      } else "your"
              ...
              "render the final tax calculation page" that {
                "is in English" in {
                  ...
                  res should have(
                    ...
                    elementAttributeBySelector(Selectors.contributionDueRowText, "href")(
                      ExpectedValues.contributionLink(isAgent)
                    ),
                    elementTextBySelector(Selectors.chargeInformationParagraph)(
                      ExpectedValues.chargeInformationParagraph(isAgent)
                    ),
                ...
                "is in welsh" in {
                  ...
                  res should have(
                    ...
                    elementTextBySelector(Selectors.chargeInformationParagraph)(
                      ExpectedValuesWelsh.chargeInformationParagraph(isAgent)
                    ),
