...
class SingleYearOptOutWarningControllerISpec extends ControllerISpecHelper {
  ...
  private val confirmOptOutPageUrl = controllers.optOut.oldJourney.routes.ConfirmOptOutController.show(isAgent).url
  private val optOutCancelledUrl = controllers.optOut.oldJourney.routes.OptOutCancelledController.show().url
