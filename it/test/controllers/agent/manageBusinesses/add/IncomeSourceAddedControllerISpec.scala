...
class IncomeSourceAddedControllerISpec extends ComponentSpecBase{
  ...
  val testObligationsModel: ObligationsModel = ObligationsModel(Seq(NextUpdatesModel("123", List(NextUpdateModel(day, day.plusDays(1), day.plusDays(2), "EOPS", None, "EOPS", Fulfilled)))))
