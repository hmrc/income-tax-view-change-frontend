...
class IncomeSourceAddedBackErrorControllerISpec extends ControllerISpecHelper {
  ...
  val pathSE = "/agents/income-sources/add/cannot-go-back-business-reporting-method"
  val pathUKProperty = "/agents/income-sources/add/cannot-go-back-uk-property-reporting-method"
  val pathForeignProperty = "/agents/income-sources/add/cannot-go-back-foreign-property-reporting-method"
