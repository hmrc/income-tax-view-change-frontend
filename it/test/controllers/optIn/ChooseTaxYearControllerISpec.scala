...
object ChooseYearControllerISpec {
  ...
  val description2InsetText =
    "Because you would be voluntarily opted in, there would be no penalties for overdue quarterly updates."
  val description2Text =
    "If in future you are no longer voluntary and reporting quarterly is mandatory, then penalties would apply. We will send you a letter if reporting quarterly becomes mandatory for you."
  val dropdownHeading = "How to submit overdue updates"
  val dropdownInsetText1 =
    "A single quarterly update covers a 3-month period for one of your income sources. For example, if you have 2 income sources and have missed 2 quarters, you would have 4 overdue updates."
          ...
          "is authenticated, with a valid enrolment" should {
            "render the choose tax year page" in {
              ...
              result should have(
                ...
                elementTextBySelector("summary.govuk-details__summary:nth-child(1) > span:nth-child(1)")(
                  dropdownHeading
                ),
                ...
                elementTextBySelector(
                  "#whichTaxYear.govuk-fieldset legend.govuk-fieldset__legend.govuk-fieldset__legend--m"
                )("Which tax year do you want to opt in from?"),
            ...
            "return a BadRequest" when {
              "the form is invalid" in {
                ...
                result should have(
                  ...
                  elementTextBySelector(".bold > a:nth-child(1)")(
                    "Select the tax year that you want to report quarterly from"
                  ),
                  elementTextBySelector("#choice-error")(
                    "Error: Select the tax year that you want to report quarterly from"
                  )
                )
              }
            }
