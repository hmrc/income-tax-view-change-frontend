...
object ConfirmTaxYearControllerISpec {
  ...
  val text: String =
    "If you have submitted any income and expenses for this tax year to HMRC, this will be deleted from our records. " +
...
object ConfirmNextTaxYearMessages {
  ...
  val desc =
    "If you opt in for the next tax year, from 6 April 2023 you will need to submit your quarterly updates through compatible software."
  val emptyBodyString = ""
  val confirmButton   = "Confirm and save"
  val cancelButton    = "Cancel"
}
            ...
            "redirect to completed page" when {
              "the user is opting in for current tax year" in {
                ...
                ITSAStatusUpdateConnectorStub.stubItsaStatusUpdate(
                  propertyOnlyResponse.asInstanceOf[IncomeSourceDetailsModel].nino,
                  Status.NO_CONTENT,
                  emptyBodyString
                )
