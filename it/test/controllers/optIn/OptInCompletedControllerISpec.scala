            ...
            "render the completed page" that {
              "is for the current tax year" in {
                ...
                result should have(
                  ...
                  elementTextByClass("govuk-panel__body")(
                    "You are now reporting quarterly from 2022 to 2023 tax year onwards"
                  )
                )
              }
              ...
              "that is for next tax year" in {
                ...
                result should have(
                  ...
                  elementTextBySelector("h1")("Opt in completed"),
                  elementTextByClass("govuk-panel__body")(
                    "You opted in to quarterly reporting from 2023 to 2024 tax year onwards"
                  )
                )
              }
            }
