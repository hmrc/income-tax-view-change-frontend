...
object PreviousObligationsIntegrationTestConstants {
  ...
  def previousQuarterlyObligation(incomeId: String): GroupedObligationsModel =
  ...
  def previousEOPSObligation(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  val previousObligationsModel = ObligationsModel(
    Seq(
