...
object NextUpdatesIntegrationTestConstants {
  ...
  def multipleNextUpdatesDataSuccessModel(incomeId: String): GroupedObligationsModel =
  ...
  def singleObligationQuarterlyReturnModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  val singleObligationCrystallisationModel: GroupedObligationsModel = GroupedObligationsModel(
    testMtditid,
    List(
      SingleObligationModel(
        start = singleObligationStart,
  ...
  def singleObligationOverdueModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  val singleObligationEOPSPropertyModel = GroupedObligationsModel(
    testPropertyId,
    List(
      SingleObligationModel(
  ...
  val multipleObligationPropertyModel = GroupedObligationsModel(
    testPropertyId,
    List(
      SingleObligationModel(
        singleObligationStartEOPs,
  ...
  def noObligationsModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
      )
  ...
  def singleObligationQuarterlyModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  def singleObligationPlusYearOpenModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  def SEIncomeSourceEOPSModel(incomeId: String): GroupedObligationsModel =
    GroupedObligationsModel(
      incomeId,
      List(
        SingleObligationModel(
  ...
  val crystallisedEOPSModel = GroupedObligationsModel(
    testMtditid,
    List(
      SingleObligationModel(
        start = LocalDate.of(2017, 4, 6),
  ...
  val crystallisedEOPSModelMulti = GroupedObligationsModel(
    testMtditid,
    List(
      SingleObligationModel(
