...
import common.enums.TriggeredMigration.Channel.{HmrcConfirmed, HmrcUnconfirmed}
        ...
        "is Authenticated, with a valid enrolment" should {
          "render the Check HMRC Records page" that {
            "has an active sole trader business, uk property and foreignProperty" in {
              ...
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, multipleBusinessesWithBothPropertiesAndCeasedBusiness.copy(channel = HmrcUnconfirmed.getValue))
            ...
            "has an active sole trader business and uk property only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, multipleBusinessesAndUkProperty.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has an active sole trader business and foreign property only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, businessWithLatency.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has an active uk property and foreign property only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, propertyOnlyBusiness.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has an active sole trader business only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, singleBusinessResponse.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has an active uk property only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, ukPropertyOnlyResponse.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has an active foreign property only" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, foreignPropertyAndCeasedBusiness.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
            ...
            "has active businesses with an unknown income source and business name" in {
              stubAuthorised(mtdUserRole, List(TriggeredMigration))
              GetInsourceDetailsStub.stubGetIncomeSourceDetailsResponse(testMtditid)(OK, businessOnlyResponseWithUnknownAddressName.copy(channel = HmrcUnconfirmed.getValue))
              ITSAStatusDetailsStub.stubGetITSAStatusFutureYearsDetails(TaxYear(2023, 2024), ITSAStatus.Voluntary, ITSAStatus.Voluntary, ITSAStatus.Voluntary)
              IncomeTaxCalculationStub.stubGetCalculationResponse(testNino, "2018", Some("LATEST"))(
                status = OK,
                body = liabilityCalculationModelSuccessfulNotCrystallised
