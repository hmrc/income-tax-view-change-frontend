...
object FinancialDetailsIntegrationTestConstants {
  ...
  def fullDocumentDetailWithDueDateModel(implicit dateService: DateService): DocumentDetailWithDueDate = DocumentDetailWithDueDate(fullDocumentDetailModel, Some(LocalDate.of(2019, 5, 15)))
  ...
  def whatYouOweDataWithDataDueIn30Days(implicit dateService: DateService): WhatYouOweChargesList = WhatYouOweChargesList(
    balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None),
    chargesList = List(DocumentDetailWithDueDate(DocumentDetail(2022, "1040000123",
      ...
      DocumentDetailWithDueDate(DocumentDetail(2022, "1040000124", Some("ITSA- POA 1"), None, Some(2000), Some(2000), LocalDate.parse("2018-03-29"),
        None, None, None, None, None, None, None, None, None), Some(LocalDate.parse("2022-01-01")), false, false, false),
      DocumentDetailWithDueDate(DocumentDetail(2022, "1040000125", Some("ITSA - POA 2"), None, Some(2000), Some(2000), LocalDate.parse("2018-03-29"),
        None, None, None, None, None, None, None, None, None), Some(LocalDate.parse("2022-01-01")), false, false, false))
    ,
  ...
  def whatYouOweDataWithDataDueInSomeDays(implicit dateService: DateService): WhatYouOweChargesList = {
    val inScopeChargeList = List(
      DocumentDetailWithDueDate(
        DocumentDetail(2022, "1040000123",
          ...
          Some(LocalDate.parse("2018-03-29")), Some(100), None, None, None), Some(LocalDate.parse("2018-03-29")), true, false, false),
      DocumentDetailWithDueDate(
        DocumentDetail(2022, "1040000124", Some("ITSA- POA 1"), None, Some(2000), Some(2000), LocalDate.parse("2018-03-29"),
        None, None, None, None, None, None, None, None, None), Some(LocalDate.parse("2022-01-01")), false, false, false),
      DocumentDetailWithDueDate(
        DocumentDetail(2022, "1040000125", Some("ITSA - POA 2"), None, Some(2000), Some(2000), LocalDate.parse("2018-03-29"),
        None, None, None, None, None, None, None, None, None), Some(LocalDate.parse("2022-01-01")), false, false, false)
    )
  ...
  def whatYouOweWithAZeroOutstandingAmount(implicit dateService: DateService): WhatYouOweChargesList = WhatYouOweChargesList(
    balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None),
    chargesList = List(DocumentDetailWithDueDate(DocumentDetail(2022, "transId1", Some("ITSA- POA 1"), None, Some(1000), Some(3400),
      ...
      DocumentDetailWithDueDate(DocumentDetail(2022, "transId2", Some("ITSA- POA 1"), None, Some(100), Some(1000), LocalDate.parse("2018-03-29"),
