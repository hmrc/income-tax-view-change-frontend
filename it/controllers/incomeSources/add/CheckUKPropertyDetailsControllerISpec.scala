...
class CheckUKPropertyDetailsControllerISpec extends ComponentSpecBase {
  object CheckUKPropertyDetails {
    ...
    val successUrl: String = controllers.incomeSources.add.routes.UKPropertyReportingMethodController.show().url
    val failureUrl: String = controllers.incomeSources.add.routes.IncomeSourceNotAddedController.show(UkProperty.key).url
