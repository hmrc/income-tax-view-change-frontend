  ...
  "The IncomeSourceNotCeasedController.show - Individual" should {
    "200 OK" when {
      "user is authorised with a business income source type in the request" in {
        ...
        val result = IncomeTaxViewChangeFrontend.get(uri = "/income-sources/cease/error-business-not-ceased")
      ...
      "user is authorised with a UK property income source type in the request" in {
        ...
        val result = IncomeTaxViewChangeFrontend.get(uri = "/income-sources/cease/error-uk-property-not-ceased")
      ...
      "user is authorised with a foreign property income source type in the request" in {
        ...
        val result = IncomeTaxViewChangeFrontend.get(uri = "/income-sources/cease/error-foreign-property-not-ceased")
