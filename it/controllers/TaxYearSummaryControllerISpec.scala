    ...
    "Tax years overview page" should {
      "should show the updated Tax Year summary page" in {
        ...
        res should have(
          ...
          elementTextBySelectorList("#payments", "tbody", "tr:nth-of-type(1)", "td:nth-of-type(3)")("£1,000.00"),
          ...
          elementTextBySelectorList("#payments", "table", "tr:nth-of-type(2)", "td:nth-of-type(3)")("£100.00"),
      ...
      "should show Tax Year Summary page with payments with and without dunning locks in the payments tab" in {
        ...
        res should have(
          ...
          elementTextBySelectorList("#payments", "table", "tr:nth-of-type(2)", "td:nth-of-type(3)")("£2,000.00"),
          ...
          elementTextBySelectorList("#payments", "table", "tr:nth-of-type(3)", "td:nth-of-type(3)")("£100.00"),
