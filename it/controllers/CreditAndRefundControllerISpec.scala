    ...
    "display the credit and refund page" when {
      "a valid response is received" in {
        ...
        res should have(
          ...
          elementAttributeBySelector("#credit-and-refund-0", "href")(s"/report-quarterly/income-and-expenses/view/credits-from-hmrc/$testPreviousTaxYearAsString"),
          ...
          elementAttributeBySelector("#credit-and-refund-1", "href")(s"/report-quarterly/income-and-expenses/view/credits-from-hmrc/$testPreviousTaxYearAsString"),
          ...
          elementAttributeBySelector("#credit-and-refund-2", "href")(s"/report-quarterly/income-and-expenses/view/credits-from-hmrc/$testPreviousTaxYearAsString"),
          ...
          elementAttributeBySelector("#credit-and-refund-3", "href")(s"/report-quarterly/income-and-expenses/view/credits-from-hmrc/$testPreviousTaxYearAsString"),
