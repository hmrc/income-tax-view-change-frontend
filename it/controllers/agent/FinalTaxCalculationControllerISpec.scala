...
class FinalTaxCalculationControllerISpec extends ComponentSpecBase with SessionCookieBaker {
  ...
  object ExpectedValues {
    val title = messageTitle("htmlTitle.agent", messages("final-tax-overview.agent.heading"))
    ...
    val contributionLink = "/report-quarterly/income-and-expenses/view/agents/2018/tax-calculation"
  ...
  object ExpectedValuesWelsh {
    val title = toMessages("CY")(s"final-tax-overview.agent.heading") + " - " +toMessages("CY")(s"htmlTitle.agent") + " - " + messagesAPI("base.govUk")
