...
class ForeignPropertyAddedObligationsControllerISpec extends ComponentSpecBase {
  ...
  val foreignPropertyObligationsShowAgentUrl: String = controllers.incomeSources.add.routes.ForeignPropertyAddedObligationsController.showAgent("").url
  ...
  val foreignPropertyAddedObligationsSubmitAgentUrl: String = controllers.incomeSources.add.routes.ForeignPropertyAddedObligationsController.submitAgent().url
