...
import testConstants.BaseIntegrationTestConstants.{clientDetailsWithConfirmation, testEndDate2022, stringTrue, testMtditid, testPropertyIncomeId, testSelfEmploymentId}
