      ...
      "NewFinancialDetailsApi FS is enabled" when {
        ...
        "render the payments due page with multiple transactions" in {
          ...
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2017-04-06", "2018-04-05")(OK,
            testValidFinancialDetailsModelJson(2000.00, 2000.00))
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2018-04-06", "2019-04-05")(OK,
            testValidFinancialDetailsModelJson(3000.00, 3000.00, "2019"))
        ...
        "render the payments due page where there is a mix of paid, unpaid and non charge transactions" in {
          ...
          val mixedJson = Json.obj(
            "financialDetails" -> Json.arr(
              ...
              chargeJson(Some(1000.00), None, Some(3400), "2019"),
              chargeJson(Some(1000.00), Some(3000.00), Some(3400), "2019"),
              chargeJson(Some(-1000.00), Some(-3000.00), Some(3400), "2019")
            ))
        ...
        "render the payments due page with a single transaction and a not found" in {
          ...
          And("I wiremock stub a single financial transaction response")
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2017-04-06", "2018-04-05")(NOT_FOUND, testFinancialDetailsErrorModelJson("400"))
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2018-04-06", "2019-04-05")(OK,
            testValidFinancialDetailsModelJson(3000, 3000, "2019"))
        ...
        "render the payments due page with no transactions" in {
          ...
          And("I wiremock stub a single financial transaction response")
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2017-04-06", "2018-04-05")(OK, testEmptyFinancialDetailsModelJson)
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2018-04-06", "2019-04-05")(OK, testEmptyFinancialDetailsModelJson)
        ...
        "redirect to an internal server error page when transactions contain internal server error" in {
          ...
          And("I wiremock stub a single financial transaction response")
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2017-04-06", "2018-04-05")(INTERNAL_SERVER_ERROR, testFinancialDetailsErrorModelJson())
          IncomeTaxViewChangeStub.stubGetFinancialDetailsResponse(testNino, "2018-04-06", "2019-04-05")(OK,
            testValidFinancialDetailsModelJson(300, 300, "2019"))
