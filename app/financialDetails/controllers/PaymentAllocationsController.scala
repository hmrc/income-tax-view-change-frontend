...
import financialDetails.controllers.errors.routes as financialDetailsErrorRoutes
import financialDetails.controllers.agent.errors.routes as agentFinancialDetailsErrorRoutes
import financialDetails.models.paymentAllocationCharges.{PaymentAllocationError, PaymentAllocationViewModel}
...
class PaymentAllocationsController @Inject()(val paymentAllocationView: PaymentAllocationView,
  ...
  private lazy val redirectUrlIndividual: String = financialDetailsErrorRoutes.NotFoundDocumentIDLookupController.show().url
  private lazy val redirectUrlAgent: String = agentFinancialDetailsErrorRoutes.AgentNotFoundDocumentIDLookupController.show().url
