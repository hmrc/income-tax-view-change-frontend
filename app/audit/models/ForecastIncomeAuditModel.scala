...
case class ForecastIncomeAuditModel(user: MtdItUserWithNino[_], endOfYearEstimate: EndOfYearEstimate)
  ...
  val incomeTypeValues = Map(
    ...
    "09" -> "Interest from UK banks, building societies and securities",
    "10" -> "Dividends from UK companies",
    "11" -> "stateBenefitIncome",
    "12" -> "Gains on life insurance policies",
    "13" -> "Share schemes",
    "14" -> "profitFromPartnership",
    "15" -> "Profit from foreign land and property",
    "16" -> "foreignInterest",
    "17" -> "Other dividends",
    "18" -> "UK securities",
    "19" -> "otherIncome",
