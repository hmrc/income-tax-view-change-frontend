...
package returns.models.finalTaxCalculation
...
object TaxReturnRequestModel {
  implicit val formats: OFormat[TaxReturnRequestModel] = Json.format[TaxReturnRequestModel]
}
