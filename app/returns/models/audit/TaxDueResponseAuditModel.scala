...
import returns.models.liabilitycalculation.viewmodels.*
...
case class TaxDueResponseAuditModel(mtdItUser: MtdItUser[_],
  ...
  private def calcMessageCodeToString(id: String): Option[String] = {
    ...
    id match {
      ...
      case "C22209" => for {
        band <- modifiedBaseBandLimit
        } yield s"Your basic rate limit has been increased to $band for pension contribution and Gift Aid payments"
