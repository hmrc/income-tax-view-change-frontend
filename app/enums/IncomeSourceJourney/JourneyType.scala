...
case class JourneyType(journeyOperation: JourneyOperation, businessType: BusinessType){
  override def toString: String = journeyOperation.operationType + "-" + businessType.toString
}
object JourneyType {

}

sealed trait JourneyOperation {
  val operationType: String
}
case object AddJourney extends JourneyOperation {
...
case object SE extends BusinessType {
