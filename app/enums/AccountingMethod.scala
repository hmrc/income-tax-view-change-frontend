...
case object AccrualsAsAccountingMethod extends AccountingMethod {
  override val name: String = "accruals"
}

case object CashAsAccountingMethod extends AccountingMethod {
