      ...
      .fold(
        ...
        },
        {
          ...
          case SingleTaxYearOptInWarningForm(Some(false)) if isAgent =>
            Future.successful(Redirect(controllers.routes.HomeController.showAgent.url)) // TODO: Replace with OptIn Cancelled
          case SingleTaxYearOptInWarningForm(Some(false)) =>
            Future.successful(Redirect(controllers.routes.HomeController.show().url)) // TODO: Replace with OptIn Cancelled
          case _ =>
