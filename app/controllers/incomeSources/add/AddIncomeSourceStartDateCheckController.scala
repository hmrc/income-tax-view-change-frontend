    ...
    (isAgent, incomeSourceType) match {
      case (false, SelfEmployment) =>
        (
          ...
          controllers.incomeSources.add.routes.AddBusinessTradeController.show(isAgent = false, isChange = false)
        )
      ...
      case (true, SelfEmployment) =>
        (
          ...
          controllers.incomeSources.add.routes.AddBusinessTradeController.show(isAgent = true, isChange = false)
        )
