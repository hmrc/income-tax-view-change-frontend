...
class IncomeSourceReportingMethodNotSavedController @Inject()(val authorisedFunctions: AuthorisedFunctions,
  ...
  def handleRequest(isAgent: Boolean, incomeSourceType: IncomeSourceType)
    ...
    val action: Call =
      if (isAgent)
        controllers.incomeSources.add.routes.IncomeSourceAddedObligationsController.showAgent(incomeSourceType)
      else
        controllers.incomeSources.add.routes.IncomeSourceAddedObligationsController.show(incomeSourceType)
