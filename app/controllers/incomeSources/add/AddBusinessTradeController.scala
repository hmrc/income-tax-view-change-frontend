...
class AddBusinessTradeController @Inject()(authenticate: AuthenticationPredicate,
  ...
  lazy val checkBusinessStartDate: String = controllers.incomeSources.add.routes.AddIncomeSourceStartDateCheckController.show(SelfEmployment, isAgent = false, isChange = false).url
  lazy val checkBusinessStartDateAgent: String = controllers.incomeSources.add.routes.AddIncomeSourceStartDateCheckController.show(SelfEmployment, isAgent = true, isChange = false).url
