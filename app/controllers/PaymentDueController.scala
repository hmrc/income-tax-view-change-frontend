...
class PaymentDueController @Inject()(implicit val config: FrontendAppConfig,
  ...
  private def hasFinancialTransactionsError(transactionModels: List[FinancialTransactionsResponseModel]): Boolean = {
