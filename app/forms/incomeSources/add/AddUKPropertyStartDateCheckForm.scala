...
//
//object AddUKPropertyStartDateCheckForm extends Constraints {
...
//      )(AddUKPropertyStartDateCheckForm.apply)(AddUKPropertyStartDateCheckForm.unapply)
//    )
//  }
//}
//
//case class AddUKPropertyStartDateCheckForm(response: Option[String]) extends IncomeSourceStartDateCheckForm {
//  override def toFormMap: Map[String, Seq[String]] = Map(
//    AddUKPropertyStartDateCheckForm.response -> Seq(response.getOrElse("N/A"))
//  )
//}