...
object SingleTaxYearOptInWarningForm {
  ...
  val noResponseErrorMessageKey: String = "optIn.SingleTaxYearOptInWarning.form.error"

  def apply(taxYear: TaxYear)(implicit messages: Messages): Form[SingleTaxYearOptInWarningForm] = {
    val noSelectionErrorMessage: String = messages(noResponseErrorMessageKey, taxYear.startYear.toString, taxYear.endYear.toString)
