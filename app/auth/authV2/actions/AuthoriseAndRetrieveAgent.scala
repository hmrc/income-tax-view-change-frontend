...
import auth.authV2.{AgentUser, EnroledUser}
...
import uk.gov.hmrc.auth.core.{AffinityGroup, AuthorisationException, BearerTokenExpired, ConfidenceLevel, Enrolment, Enrolments, InsufficientEnrolments}
