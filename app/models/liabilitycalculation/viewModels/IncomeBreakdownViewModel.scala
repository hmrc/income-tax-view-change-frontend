...
case class IncomeBreakdownViewModel(
                                     ...
                                     totalSelfEmploymentProfit: Option[Int],
                                     totalPropertyProfit: Option[Int],
                                     totalFHLPropertyProfit: Option[Int],
                                     totalForeignPropertyProfit: Option[Int],
                                     totalEeaFhlProfit: Option[Int],
                                     chargeableForeignDividends: Option[Int],
                                     chargeableForeignSavingsAndGains: Option[Int],
