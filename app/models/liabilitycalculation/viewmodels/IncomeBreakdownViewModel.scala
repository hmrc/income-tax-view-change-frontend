...
case class IncomeBreakdownViewModel(
                                     ...
                                     totalUKOtherPropertyProfit: Option[BigDecimal] = None,
    ...
    calcOpt match {
      case Some(c) =>
        Some(IncomeBreakdownViewModel(
          ...
          totalUKOtherPropertyProfit = c.incomeSummaryTotals.flatMap(ist => ist.totalUKOtherPropertyProfit) map {i => i: BigDecimal },
