...
@Singleton
class ITSAStatusConnector @Inject() (
  ...
  def getITSAStatusDetail(
    ...
    ): Future[Either[ITSAStatusResponse, List[ITSAStatusResponseModel]]] = {
    ...
    http
      ...
      response.status match {
        case OK =>
          response.json
            .validate[List[ITSAStatusResponseModel]]
            .fold(
              invalid => {
