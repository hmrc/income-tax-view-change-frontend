        ...
        "there is only one overdue date" in {
          val financialDetailsCurrentYear: FinancialDetailsModel = FinancialDetailsModel(
            ...
            documentDetails = List(
              DocumentDetail(2018, "testTransactionId1", Some("ITSA- POA 1"), Some("documentText"), 100.00, None, LocalDate.of(2018, 3, 29), effectiveDateOfPayment = Some(fixedDate.minusDays(1)), documentDueDate = Some(fixedDate.minusDays(1))),
              DocumentDetail(2018, "testTransactionId2", Some("ITSA - POA 2"), Some("documentText"), 200.00, None, LocalDate.of(2018, 3, 29), effectiveDateOfPayment = Some(fixedDate.plusDays(1)), documentDueDate = Some(fixedDate.plusDays(1)))
            ),
          ...
          val financialDetailsLastYear: FinancialDetailsModel = FinancialDetailsModel(
            balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None, None),
            documentDetails = List(
              DocumentDetail(2018, "testTransactionId1", None, None, 100.00, None, LocalDate.of(2018, 3, 29)),
      ...
      "return a single non-overdue date" when {
        "there are no overdue dates, but there are dates upcoming" in {
          val financialDetailsCurrentYear: FinancialDetailsModel = FinancialDetailsModel(
            balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None, None),
            documentDetails = List(
              DocumentDetail(2018, "testTransactionId1", None, None, 100.00, None, LocalDate.of(2018, 3, 29), effectiveDateOfPayment = Some(fixedDate.plusDays(7))),
              DocumentDetail(2018, "testTransactionId2", None, None, 100.00, None, LocalDate.of(2018, 3, 29), effectiveDateOfPayment = Some(fixedDate.plusDays(1)))
            ),
            financialDetails = List(
          ...
          val financialDetailsLastYear: FinancialDetailsModel = FinancialDetailsModel(
            ...
            documentDetails = List(
              ...
              DocumentDetail(2018, "testTransactionId2", Some("ITSA- POA 1"), Some("documentText"), 100.00, None, LocalDate.of(2018, 3, 29), effectiveDateOfPayment = Some(fixedDate.plusDays(5)), documentDueDate = Some(fixedDate.plusDays(5)))
            ),
            financialDetails = List(
