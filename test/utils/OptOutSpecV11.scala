...
class OptOutSpecV11 extends UnitSpec {
  ...
  private val optOuts =
    Table(
      ...
      ("N", "V", "M", "M", "CY-1", "CY+1", "N/A"), // Changed from Nothing Displayed -> CY-1 (row 79 on sheet) Invalid Anyway!
      ("Y", "V", "M", "M", "Nothing displayed", "CY+1", "N/A"),
      ...
      ("Y", "V", "V", " ", "CY, CY+1", "CY-1", "N/A"), // Changed from CY -> CY, CY+1 (row 106 on sheet). Marked as Invalid but could be Valid???
      ...
      ("N", " ", "A", "A", "Nothing displayed", "CY-1", "N/A"),  // Changed from CY+1 -> Nothing displayed (row 285) Marked as Invalid, so no big deal
      ("Y", " ", "A", "A", "Nothing displayed", "CY-1", "N/A"),  // Changed from CY+1 -> Nothing displayed (row 286) Marked as Invalid, so no big deal
      ("N", " ", "A", "A", "Nothing displayed", "CY"  , "N/A"),  // Changed from CY+1 -> Nothing displayed (row 287) Marked as Invalid, so no big deal
      ("Y", " ", "A", "A", "Nothing displayed", "CY"  , "N/A"),  // Changed from CY+1 -> Nothing displayed (row 288) Marked as Invalid, so no big deal
      ("N", " ", "A", "A", "Nothing displayed", "CY+1", "N/A"),  // Changed from CY+1 -> Nothing displayed (row 289) Marked as Invalid, so no big deal
      ("Y", " ", "A", "A", "Nothing displayed", "CY+1", "N/A")   // Changed from CY+1 -> Nothing displayed (row 290) Marked as Invalid, so no big deal
    )
