...
class OptOutSpecV10_3 extends UnitSpec {
  ...
  private val optOuts =
    Table(
      ...
      ("N", "V", "M", "M", "N/A", "CY-1"),
      ("Y", "V", "M", "M", "N/A", "Nothing displayed"),
//      ("N", "V", "M", "M", "N/A", "Nothing displayed"), // Customer to opt out from CY+1 (Not allowed)
      ("Y", "V", "M", "M", "N/A", "Nothing displayed"),
      ("N", "V", "M", " ", "Allowed", "CY-1"),
      ...
      ("N", "V", "V", "M", "N/A", "CY-1, CY"),
      ("Y", "V", "V", "M", "N/A", "CY"),
      ("N", "V", "V", " ", "Allowed", "CY-1, CY, CY+1"),  // Added CY+1
      ("Y", "V", "V", " ", "N/A", "CY, CY+1"),            // Added CY+1
      ("N", "V", "V", " ", "Allowed", "CY-1, CY, CY+1"),  // Added CY+1
      ("Y", "V", "V", " ", "Allowed", "CY, CY+1"),        // Added CY+1
      ...
      ("N", " ", "A", "V", "Allowed", "CY+1"),
      ("Y", " ", "A", "V", "Allowed", "CY+1"),
      ("N", " ", "A", "A", "N/A", "Nothing displayed"), // Changed from CY+1
      ("Y", " ", "A", "A", "N/A", "Nothing displayed"), // Changed from CY+1
      ("N", " ", "A", "A", "N/A", "Nothing displayed"), // Changed from CY+1
      ("Y", " ", "A", "A", "N/A", "Nothing displayed"), // Changed from CY+1
      ("N", " ", "A", "A", "N/A", "Nothing displayed"), // Changed from CY+1
      ("Y", " ", "A", "A", "N/A", "Nothing displayed")  // Changed from CY+1
