...
import common.generators.Generators
  ...
  "must fail to bind a date with a missing day" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing field") {
      (date, field) =>
        ...
        result.errors must contain only FormError("value", "error.required", List("date.error.day"))
    }
  }
  ...
  "must fail to bind a date with a missing month" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing field") {
      (date, field) =>
        ...
        result.errors must contain only FormError("value", "error.required", List("date.error.month"))
    }
  }
  ...
  "must fail to bind a date with a missing year" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing field") {
      (date, field) =>
        ...
        result.errors must contain only FormError("value", "error.required", List("date.error.year"))
    }
  }
  ...
  "must fail to bind a date with a missing day and month" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing day", missingField -> "missing month") {
      (date, dayOpt, monthOpt) =>
        ...
        result.errors must contain only FormError("value", "error.required.two", List("date.error.day", "date.error.month"))
    }
  }
  ...
  "must fail to bind a date with a missing day and year" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing day", missingField -> "missing year") {
      (date, dayOpt, yearOpt) =>
        ...
        result.errors must contain only FormError("value", "error.required.two", List("date.error.day", "date.error.year"))
    }
  }
  ...
  "must fail to bind a date with a missing month and year" in {
    ...
    forAll(validData -> "valid date", missingField -> "missing month", missingField -> "missing year") {
      (date, monthOpt, yearOpt) =>
        ...
        result.errors must contain only FormError("value", "error.required.two", List("date.error.month", "date.error.year"))
    }
  }
