...
class IncomeSourceCeasedObligationsViewModelSpec extends UnitSpec {
  ...
  val finalDeclarationDatesOverDue: DatesModel = DatesModel(day, day.minusDays(1), day.minusDays(2), "C", isFinalDec = true, obligationType = FinalDeclarationObligation)
