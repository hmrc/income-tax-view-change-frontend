    ...
    "return a list of only specific updates with source in date order" when {
      ...
      "calling .groupByQuarterPeriod" in {
        ...
        NextUpdatesTestConstants.obligationsAllDeadlinesSuccessModel.groupByQuarterPeriod(
          ...
          None -> List(
            NextUpdateModelWithIncomeType("nextUpdates.crystallisedAll",NextUpdateModel("2017-10-01","2018-10-30","2017-10-31","Crystallised",None,"", Fulfilled.code))),
          Some(QuarterTypeCalendar) -> List(
            NextUpdateModelWithIncomeType("nextUpdates.business", NextUpdateModel("2017-07-01", "2017-09-30", "2017-10-30", "Quarterly", None, "#002", Fulfilled.code)),
            NextUpdateModelWithIncomeType("nextUpdates.business", NextUpdateModel("2017-07-01", "2017-09-30", "2017-10-31", "Quarterly", None, "#003", Fulfilled.code))),
          Some(QuarterTypeStandard) -> List (
            NextUpdateModelWithIncomeType("nextUpdates.propertyIncome", NextUpdateModel("2017-04-06", "2018-04-05", "2017-10-01", "Quarterly", None, "#002", Fulfilled.code)),
            NextUpdateModelWithIncomeType("nextUpdates.propertyIncome", NextUpdateModel("2017-04-06", "2018-04-05", "2017-10-31", "Quarterly", None, "#003", Fulfilled.code)))
        )
      }
    }
  }
