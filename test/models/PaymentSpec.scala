...
class PaymentSpec extends WordSpecLike with Matchers {
  ...
  val paymentFull: Payment = Payment(reference = Some("reference"), amount = Some(100.00),
    method = Some("method"), lot = Some("lot"), lotItem = Some("lotItem"),
    documentDescription = None,
    date = Some("date"), transactionId = Some("DOCID01"))
  ...
  val paymentMinimal: Payment = Payment(None, None, None, None, None, None, None, None)
