...
trait CreditHistoryDataHelper {
  ...
  val expectedBalancedDetails = BalanceDetails(1.0, 2.0, 4.0, 3.0, None, None, None, None, None, None, None, None)
  ...
  val creditDetailModelasCutOver = CreditDetailModel(
    ...
    CutOverCreditType,
    availableCredit = expectedBalancedDetails.totalCreditAvailableForRepayment
  )
