...
object FinancialDetailsTestConstants {
  ...
  lazy val testValidFinancialDetailsModelJsonWrites: JsValue = Json.obj(
    ...
    "documentDetails" -> Json.arr(
      ...
      Json.obj(
        "taxYear" -> "2020",
        "documentID" -> id1040000124,
        "documentDescription" -> "TRM New Charge",
        "documentText" -> "documentText",
        "documentOutstandingAmount" -> 10.34,
        "totalAmount" -> 10.34,
        "documentDate" -> "2018-03-29",
        "interestOutstandingAmount" -> 100,
        "interestRate" -> 100,
...
//          dunningLock = Some("Stand over order"),
  ...
  private def testFinancialDetailsModel(dueDate: List[Option[LocalDate]],
                                        ...
                                        balanceDetails: BalanceDetails = BalanceDetails(1.00, 2.00, 4.00, 3.00, None, None, None, None, None, None, None, None)): FinancialDetailsModel =
    FinancialDetailsModel(
      balanceDetails = balanceDetails,
      documentDetails = List(
  ...
  def financialDetailsDueInMoreThan30Days(dunningLocks: List[Option[String]] = noDunningLocks): FinancialDetailsModel = testFinancialDetailsModel(
    ...
    balanceDetails = BalanceDetails(0.00, 2.00, 4.00, 2.00, Some(100.00), None, None, Some(350.00), None, None, Some(100.00), None)
  )
  ...
  def financialDetailsDueIn30Days(dunningLocks: List[Option[String]] = noDunningLocks): FinancialDetailsModel = testFinancialDetailsModel(
    ...
    dunningLock = dunningLocks,
    balanceDetails = BalanceDetails(50.00, 0.00, 0.00, 50.00, None, None, None, None, None, None, None, None)
  )
  ...
  def financialDetailsOverdueData(dunningLocks: List[Option[String]] = noDunningLocks): FinancialDetailsModel = testFinancialDetailsModel(
    ...
    dunningLock = dunningLocks,
    balanceDetails = BalanceDetails(0.00, 3.00, 0.00, 3.00, None, None, None, None, None, None, None, None)
  )
...
//
  ...
  lazy val whatYouOweEmptyMFA: WhatYouOweChargesList = WhatYouOweChargesList(BalanceDetails(1.0, 2.0, 0.0, 3.0, None, None, None, None, None, None, None, None), List(), Some(OutstandingChargesModel(List())), None)
...
//  )
  ...
  lazy val whatYouOweEmpty: WhatYouOweChargesList = WhatYouOweChargesList(BalanceDetails(1.0, 2.0, 4.0, 3.0, None, None, None, None, None, None, None, None), List(), Some(OutstandingChargesModel(List())), None)
  ...
  lazy val financialDetailCreditCharge = FinancialDetailsModel(
    balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, Some(6.00), Some(1.00), Some(3.00), Some(7.00), Some(2.00), Some(4.00), None, None),
  ...
  lazy val financialDetailCreditAndRefundCharge = FinancialDetailsModel(
    balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, Some(6.00), Some(0), Some(3.00), Some(7.00), Some(2.00), Some(4.00), None, None),
  ...
  lazy val financialDetailCreditAndRefundChargeAllCreditTypes = FinancialDetailsModel(
    balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, Some(1.00), Some(6.00), Some(3.00), Some(7.00), Some(2.00), Some(4.00), None, None),
...
//    ))
  ...
  lazy val MFADebitsFinancialDetails: FinancialDetailsModel = FinancialDetailsModel(
    balanceDetails = BalanceDetails(1.00, 2.00, 0.00, 3.00, Some(6.00), Some(3.00), Some(7.00), Some(1.00), Some(2.00), Some(4.00), None, None),
...
case class ANewCreditAndRefundModel(model: CreditsModel = CreditsModel(0.0, 0.0, 0.0, 0.0, None, None, Nil)) {
  ...
  def withCutoverCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.cutOverCredit(dueDate, outstandingAmount)))
  }
  ...
  def withBalancingChargeCredit(dueDate: LocalDate, outstandingAmount: BigDecimal, id: String = "balancing") = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.balancingChargeCredit(dueDate, outstandingAmount, id)))
  }

  def withRepaymentInterest(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.repaymentInterestCredit(dueDate, outstandingAmount)))
  }

  def withMfaCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.mfaCredit(dueDate, outstandingAmount)))
  }

  def withPayment(dueDate: LocalDate, outstandingAmount: BigDecimal, effectiveDateOfPayment: Option[LocalDate] = None) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.payment(dueDate,  outstandingAmount, effectiveDateOfPayment)))
  }

  def withPoaOneReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.poaOneReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal)))
  }

  def withPoaTwoReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.poaTwoReconciliationCredit(dueDate: LocalDate, outstandingAmount: BigDecimal)))
  }

  def withITSAReturnAmendmentCredit(dueDate: LocalDate, outstandingAmount: BigDecimal) = {
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.itsaReturnAmendmentCredit(dueDate: LocalDate, outstandingAmount: BigDecimal)))
  }
  
  def withHmrcAutoCorrection(dueDate: LocalDate, outstandingAmount: BigDecimal) =
    ANewCreditAndRefundModel(model.copy(transactions = model.transactions :+ TestTransactions.hmrcAutoCorrection(dueDate, outstandingAmount)))
