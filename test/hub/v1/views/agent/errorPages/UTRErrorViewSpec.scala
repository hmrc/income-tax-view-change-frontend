...
package hub.v1.views.agent.errorPages

import common.testUtils.ViewSpec
import hub.v1.views.html.agent.errorPages.UTRErrorView
...
class UTRErrorViewSpec extends ViewSpec {
  ...
  lazy val postAction: Call = hub.v1.controllers.agent.routes.UTRErrorController.submit()
  ...
  object utrErrorMessages {
    ...
    val title: String = s"${messages("agent.utr_error.title")} - GOV.UK"
