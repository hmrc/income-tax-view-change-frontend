...
package hub.v2.views.agent.errorPages

import common.testUtils.ViewSpec
import hub.v2.views.html.agent.errorPages.UTRErrorView
...
class UTRErrorViewSpec extends ViewSpec {
  ...
  lazy val postAction: Call = hub.v2.controllers.agent.routes.UTRErrorController.submit()
