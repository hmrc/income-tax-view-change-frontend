...
class ViewInYearTaxEstimateAuditModelSpec extends UnitSpec {
  ...
  val taxCalc: CalculationSummary = CalculationSummary(None, crystallised = false, unattendedCalc = false, taxDue, income, deductions, totalTaxable, calculationRevisionType = None)
