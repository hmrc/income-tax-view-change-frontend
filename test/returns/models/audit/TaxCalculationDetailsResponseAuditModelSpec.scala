...
class TaxCalculationDetailsResponseAuditModelSpec extends TestSupport {
  ...
  "TaxCalculationDetailsResponseAuditModel(user, calcDisplayModel, taxYear)" should {
    s"have the correct transaction name of: $transactionName" in {
      taxCalculationDetailsResponseAuditModelFull.transactionName shouldBe transactionName
    }

    s"have the correct audit type of: $auditType" in {
      taxCalculationDetailsResponseAuditModelFull.auditType shouldBe auditType
    }
