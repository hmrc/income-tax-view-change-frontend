...
object ChargeHistoryTestConstants {
  ...
  val testValidChargeHistoryModel: ChargesHistoryModel = ChargesHistoryModel(
    ...
    chargeHistoryDetails = Some(List(
      ChargeHistoryDetailsModel("2017", "123456789", LocalDate.parse("2020-01-29"), "Balancing Charge", 123456789012345.67, LocalDateTime.of(LocalDate.of(2020, 2, 24), LocalTime.of(9, 30, 45)), "amended return", Some("005"), None))))
