...
class SingleTaxYearWarningControllerSpec extends MockAuthActions with MockOptInService with MockitoSugar {
          ...
          "render the SingleTaxYearWarningView" in {
            ...
            contentAsString(result) shouldBe
              singleTaxYearWarningView(
                form = form,
                submitAction = controllers.optIn.routes.ConfirmTaxYearController.show(isAgent),
                isAgent = isAgent,
      ...
      s"the user is authenticated as a $mtdRole" when {
        ...
        "a there is a single available tax year" when {
          ...
          "user answers No - false" should {
            ...
            "handle the submit request and redirect to the Home page" in {
