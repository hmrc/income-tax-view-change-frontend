...
class AddBusinessAddressControllerSpec extends TestSupport
  ...
  val postAction: Call = controllers.manageBusinesses.add.routes.AddBusinessAddressController.submit(None, isChange = false)
  val postActionChange: Call = controllers.manageBusinesses.add.routes.AddBusinessAddressController.submit(None, isChange = true)
  val redirectAction: Call = controllers.manageBusinesses.add.routes.IncomeSourceCheckDetailsController.show(SelfEmployment)
  val redirectActionAgent: Call = controllers.manageBusinesses.add.routes.IncomeSourceCheckDetailsController.showAgent(SelfEmployment)
