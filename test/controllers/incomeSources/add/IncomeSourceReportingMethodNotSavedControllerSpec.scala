...
class IncomeSourceReportingMethodNotSavedControllerSpec extends MockAuthActions
  ...
  val testController = fakeApplication().injector.instanceOf[IncomeSourceReportingMethodNotSavedController]
