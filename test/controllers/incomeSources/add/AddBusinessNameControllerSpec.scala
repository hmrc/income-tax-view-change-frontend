...
class AddBusinessNameControllerSpec extends TestSupport
  ...
  val sessionDataCompletedJourney: UIJourneySessionData = UIJourneySessionData(testSessionId, journeyType.toString, Some(AddIncomeSourceData(hasBeenAdded = Some(true))))
