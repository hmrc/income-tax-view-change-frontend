...
class DeductionsSummaryControllerSpec extends TestSupport with MockCalculationService
  ...
  val allowancesAndDeductionsServiceNameIndividual: String = messageTitle("titlePattern.serviceName.govUk", messages("deduction_breakdown.heading"))
  val allowancesAndDeductionsServiceNameAgent: String = messageTitle("htmlTitle.agent", messages("deduction_breakdown.heading"))
