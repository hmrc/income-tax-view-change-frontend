...
trait ChargeConstants {
  ...
  def chargeItemModel(
      taxYear:                   TaxYear = TaxYear.forYearEnd(2018),
  ...
  private def testFinancialDetailsChargeItems(
      ...
      interestFromDate: List[Option[LocalDate]] = List(Some(LocalDate.of(2018, 3, 29)), Some(LocalDate.of(2018, 3,
                  29))),
      interestEndDate:   List[Option[LocalDate]] = List(Some(LocalDate.of(2018, 6, 15)), Some(LocalDate.of(2018, 6, 15))),
    ...
    List(
      ChargeItem(
        transactionId = transactionId.head,
  ...
  def financialDetailsOverdueInterestDataCi(latePaymentInterest: List[Option[BigDecimal]]): List[ChargeItem] =
  ...
  def financialDetailsDueInMoreThan30DaysCi(dunningLocks: List[Option[String]] = noDunningLocks): List[ChargeItem] =
    testFinancialDetailsChargeItems(
  ...
  def outstandingChargesModelIt(dueDate: LocalDate): OutstandingChargesModel =
    OutstandingChargesModel(
      List(
        OutstandingChargeModel("BCD", Some(dueDate), 123456789012345.67, 1234),
  ...
  def whatYouOweDataWithDataDueIn30DaysIt(implicit dateService: DateServiceInterface): WhatYouOweChargesList =
  ...
  def chargeItemWithCodingOutNics2Ci(): ChargeItem =
    ChargeItem(
  ...
  def chargeItemWithCodingOutCancelledPayeSaCi(): ChargeItem =
    ChargeItem(
      transactionId = "CODINGOUT01",
      taxYear = TaxYear.forYearEnd(2021),
      transactionType = BalancingCharge,
  ...
  val balancingChargeCancelled = ChargeItem(
    taxYear = TaxYear.forYearEnd(2021),
  ...
  def financialDetailsOverdueWithLpiDunningLockZeroCi(
      taxYear:             TaxYear,
  ...
  def outstandingChargesModelCi(dueDate: LocalDate): OutstandingChargesModel =
    OutstandingChargesModel(
      List(
        OutstandingChargeModel("BCD", Some(dueDate), 123456789012345.67, 1234),
        OutstandingChargeModel("ACI", None, 12.67, 1234)
  ...
  val staticDateOutstandingChargesOverdueData: OutstandingChargesModel = outstandingChargesModelCi(
    LocalDate.parse("2022-01-01")
  )

  def whatYouOweWithAZeroOutstandingAmount(
      firstTransactionType: ChargeType = BalancingCharge
    )(
  ...
  def whatYouOweDataWithPaidPOAs(
      dunningLocks: List[Option[String]] = noDunningLocks
    )(
      implicit dateService: DateService
    ): WhatYouOweChargesList =
    WhatYouOweChargesList(
  ...
  def whatYouOweDataWithDataDueIn30Days(
      dunningLocks: List[Option[String]] = noDunningLocks
    )(
      implicit dateService: DateService
    ): WhatYouOweChargesList =
  ...
  def whatYouOweDataWithDataDueIn30DaysAvailableCreditZero(
      dunningLocks: List[Option[String]] = noDunningLocks
    )(
      implicit dateService: DateService
    ): WhatYouOweChargesList =
  ...
  val whatYouOweDataWithMixedData4Unfiltered: WhatYouOweChargesList = WhatYouOweChargesList(
    balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None, None),
    chargesList = List(financialDetailsWithMixedData4Ci.head, financialDetailsWithMixedData4Ci(1)),
    outstandingChargesModel = Some(OutstandingChargesModel(List()))
  )
  ...
  def whatYouOweDataWithOverdueDataIt(dunningLocks: List[Option[String]] = noDunningLocks): WhatYouOweChargesList =
    WhatYouOweChargesList(
  ...
  def whatYouOweDataWithOverdueData(dunningLocks: List[Option[String]] = noDunningLocks): WhatYouOweChargesList =
    WhatYouOweChargesList(
      balanceDetails = BalanceDetails(0.00, 3.00, 3.00, None, None, None, None, None),
      chargesList = testFinancialDetailsChargeItems(
        dueDate = dueDateOverdue,
  ...
  def whatYouOweDataWithOverdueDataAndInterest(
      dunningLocks: List[Option[String]] = noDunningLocks
    ): WhatYouOweChargesList =
    WhatYouOweChargesList(
      balanceDetails = BalanceDetails(0.00, 3.00, 3.00, None, None, None, None, None),
  ...
  def whatYouOweDataWithDataDueInMoreThan30Days(
      dunningLocks: List[Option[String]] = noDunningLocks,
  ...
  def whatYouOweDataWithZeroMoneyInAccount(dunningLocks: List[Option[String]] = noDunningLocks): WhatYouOweChargesList =
    WhatYouOweChargesList(
  ...
  def whatYouOweDataWithAvailableCredits(dunningLocks: List[Option[String]] = noDunningLocks): WhatYouOweChargesList =
    WhatYouOweChargesList(
  ...
  def whatYouOweDataWithDataDueIn30DaysIntegration: WhatYouOweChargesList =
    WhatYouOweChargesList(
      balanceDetails = BalanceDetails(1.00, 2.00, 3.00, None, None, None, None, None),
      chargesList = List(
        chargeItemModel(
  ...
  def whatYouOweDataFullDataWithoutOutstandingCharges(
    )(
      implicit dateService: DateServiceInterface
    ): WhatYouOweChargesList =
    WhatYouOweChargesList(
  ...
  def financialDetailsOverdueDataCi() =
    testFinancialDetailsChargeItems(
