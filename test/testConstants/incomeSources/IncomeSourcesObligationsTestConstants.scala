...
object IncomeSourcesObligationsTestConstants {
  ...
  def generateQuarterDates(
      taxYear: Int
    ): (LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate) = {
  ...
  def generateTaxYearQuarterDates(
      taxYear: Int
    ): (LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate, LocalDate) = {
  ...
  val (
    ...
    startDateQ4_2022,
    endDateQ4_2022
  ) = generateQuarterDates(taxYear2022)
  ...
  val (
    ...
    startDateQ4_2023,
    endDateQ4_2023
  ) = generateQuarterDates(taxYear2023)
  ...
  val (
    ...
    startDateQ4_2024,
    endDateQ4_2024
  ) = generateQuarterDates(taxYear2024)
  ...
  val (
    ...
    startDateQ4_2025,
    endDateQ4_2025
  ) = generateQuarterDates(taxYear2025)
  ...
  val finalDeclaration2022_2023taxYear =
    DatesModel(
      startDateTaxYear2022,
      endDateTaxYear2022,
      crystallisedDeadlineTaxYear2022_2023,
      "C",
      isFinalDec = true,
  ...
  val finalDeclaration2023_2024taxYear =
    DatesModel(
      startDateTaxYear2023,
      endDateTaxYear2023,
      crystallisedDeadlineTaxYear2023_2024,
      "C",
      isFinalDec = true,
      obligationType = "Crystallised"
    )
  ...
  val finalDeclaration2024_2025taxYear =
    DatesModel(
      startDateTaxYear2024,
      endDateTaxYear2024,
      crystallisedDeadlineTaxYear2024_2025,
      "C",
      isFinalDec = true,
      obligationType = "Crystallised"
    )
  ...
  val (
    taxYear2022_2023q1startDate,
    taxYear2022_2023q1endDate,
    taxYear2022_2023q2startDate,
    taxYear2022_2023q2endDate,
    taxYear2022_2023q3startDate,
    taxYear2022_2023q3endDate,
    taxYear2022_2023q4startDate,
    taxYear2022_2023q4endDate
  ...
  val taxYear2022_2023quarterlyDates: Seq[DatesModel] = Seq(
    DatesModel(
      taxYear2022_2023q1startDate,
      taxYear2022_2023q1endDate,
      taxYear2022_2023q1endDate.plusMonths(1),
      "#001",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2022_2023q2startDate,
      taxYear2022_2023q2endDate,
      taxYear2022_2023q2endDate.plusMonths(1),
      "#002",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2022_2023q3startDate,
      taxYear2022_2023q3endDate,
      taxYear2022_2023q3endDate.plusMonths(1),
      "#003",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2022_2023q4startDate,
      taxYear2022_2023q4endDate,
      taxYear2022_2023q4endDate.plusMonths(1),
      "#004",
      isFinalDec = false,
      obligationType = "Quarterly"
    )
  ...
  val (
    taxYear2023_2024q1startDate,
    taxYear2023_2024q1endDate,
    taxYear2023_2024q2startDate,
    taxYear2023_2024q2endDate,
    taxYear2023_2024q3startDate,
    taxYear2023_2024q3endDate,
    taxYear2023_2024q4startDate,
    taxYear2023_2024q4endDate
  ...
  val taxYear2023_2024quarterlyDates: Seq[DatesModel] = Seq(
    DatesModel(
      taxYear2023_2024q1startDate,
      taxYear2023_2024q1endDate,
      taxYear2023_2024q1endDate.plusMonths(1),
      "#001",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2023_2024q2startDate,
      taxYear2023_2024q2endDate,
      taxYear2023_2024q2endDate.plusMonths(1),
      "#002",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2023_2024q3startDate,
      taxYear2023_2024q3endDate,
      taxYear2023_2024q3endDate.plusMonths(1),
      "#003",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2023_2024q4startDate,
      taxYear2023_2024q4endDate,
      taxYear2023_2024q4endDate.plusMonths(1),
      "#004",
      isFinalDec = false,
      obligationType = "Quarterly"
    )
  ...
  val (
    taxYear2024_2025q1startDate,
    taxYear2024_2025q1endDate,
    taxYear2024_2025q2startDate,
    taxYear2024_2025q2endDate,
    taxYear2024_2025q3startDate,
    taxYear2024_2025q3endDate,
    taxYear2024_2025q4startDate,
    taxYear2024_2025q4endDate
  ...
  val taxYear2024_2025quarterlyDates: Seq[DatesModel] = Seq(
    DatesModel(
      taxYear2024_2025q1startDate,
      taxYear2024_2025q1endDate,
      taxYear2024_2025q1endDate.plusMonths(1),
      "#001",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2024_2025q2startDate,
      taxYear2024_2025q2endDate,
      taxYear2024_2025q2endDate.plusMonths(1),
      "#002",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2024_2025q3startDate,
      taxYear2024_2025q3endDate,
      taxYear2024_2025q3endDate.plusMonths(1),
      "#003",
      isFinalDec = false,
      obligationType = "Quarterly"
    ),
    DatesModel(
      taxYear2024_2025q4startDate,
      taxYear2024_2025q4endDate,
      taxYear2024_2025q4endDate.plusMonths(1),
      "#004",
      isFinalDec = false,
      obligationType = "Quarterly"
    )
  ...
  val quarterlyObligationDatesSimple =
    Seq(quarterlyDatesYearOneSimple, quarterlyDatesYearTwoSimple, quarterlyDatesYearThreeSimple)

  val singleYearTwoQuarterlyDates = Seq(
    Seq(
      DatesModel(
        startDateQ1_2022,
        endDateQ1_2022,
