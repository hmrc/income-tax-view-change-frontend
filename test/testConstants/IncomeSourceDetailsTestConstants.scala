...
object IncomeSourceDetailsTestConstants {
  ...
  val ukPropertyAndSoleTraderBusinessIncomeInvalid = IncomeSourceDetailsModel(testMtdItId, Some("2018"), List(soleTraderBusinessNoBusinessName), List(ukPropertyDetails))
