...
object IncomeSourceDetailsTestConstants {
  ...
  val businessIncome2018and2019 = IncomeSourceDetailsModel(testMtdItId, None, List(business2018, business2019), Some(propertyDetails))
  ...
  val noIncomeDetails = IncomeSourceDetailsModel(testMtdItId, None, List(), Some(propertyDetails))
