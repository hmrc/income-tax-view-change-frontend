...
import testConstants.BaseTestConstants.{testErrorMessage, testErrorStatus, testMigrationYear2019, testMtditid2}
...
object IncomeSourceDetailsTestConstants {
  ...
  val businessIncome = IncomeSourceDetailsModel(testMtditid2, Some("2018"), List(soleTraderBusiness), List())
  val businessIncome2 = IncomeSourceDetailsModel(testMtdItId, Some("2018"), List(soleTraderBusiness2), List())
