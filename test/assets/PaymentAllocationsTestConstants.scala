...
import models.paymentAllocations.{AllocationDetail, PaymentAllocationsErrorModel, PaymentAllocationsModel, PaymentAllocationsResponseModel}
...
object PaymentAllocationsTestConstants {
  ...
  val testValidPaymentAllocationsModel: PaymentAllocationsModel = PaymentAllocationsModel(
    Some(110.10), Some("Payment by Card"), Some("2019-05-27"),
    Seq(
  ...
  val testPaymentAllocationsErrorModelParsing: PaymentAllocationsErrorModel = PaymentAllocationsErrorModel(
    testErrorStatus, "Json Validation Error. Parsing Payment Allocations Data Response")

  val testPaymentAllocationsErrorModel: PaymentAllocationsErrorModel = PaymentAllocationsErrorModel(testErrorStatus, testErrorMessage)
