...
object PaymentAllocationsTestConstants {
  ...
  val testValidPaymentAllocationsModel: PaymentAllocations = PaymentAllocations(
    ...
    Seq(
      AllocationDetail(Some("1040000872"), Some("2019-06-27"), Some("2019-08-27"), Some("NIC4 Wales"), Some(10.10), Some(5.50)),
      AllocationDetail(Some("1040000873"), Some("2019-07-28"), Some("2019-09-28"), Some("NIC4 Wales"), Some(10.90), Some(5.90))
    )
  )
