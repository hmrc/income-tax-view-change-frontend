...
class TaxYearSummaryViewSpec extends ViewSpec with FeatureSwitching with ChargeConstants {
  ...
  object TaxYearSummaryMessages {
    ...
    val secondaryHeading: String = "6 Apr {0} to 5 Apr {1}"
    val calculationDate: String = "Calculation date"
    val calcDate: String = "1 Jan 2020"
    val estimate: String = s"6 Apr ${testYear - 1} to 1 Jan 2020 estimate"
    val totalDue: String = "Total tax bill"
    val taxDue: String = "£4.04"
    val calDateFrom: String = implicitDateFormatter.longDate(LocalDate.of(testYear - 1, 1, 1)).toLongDateShort
    val calDateTo: String = implicitDateFormatter.longDate(LocalDate.of(testYear, 1, 1)).toLongDateShort
