  ...
  "ConfirmedOptOutView" when {
    ...
    "Scenario2" when {
      ...
      "show the 'Your reporting obligations' section" in {
        ...
        pageDocument.getElementById(Selectors.requiredToUseMtdInset).text() shouldBe "From 6 April 2025, you will be required to use Making Tax Digital for Income tax."
