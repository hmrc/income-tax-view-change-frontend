...
class ManageObligationsViewSpec extends ViewSpec {
  ...
  val backUrl: String = controllers.incomeSources.manage.routes.ConfirmReportingMethodSharedController.show(None, annually, taxYearString, UkProperty.key, isAgent = false).url
