...
class ForeignPropertyCheckDetailsViewSpec extends ViewSpec{
  ...
  val changeDateLinkIndiv: String = controllers.incomeSources.add.routes.AddIncomeSourceStartDateController.show(ForeignProperty, isAgent = false, isChange = true).url
