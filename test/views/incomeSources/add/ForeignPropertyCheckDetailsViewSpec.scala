...
//
//  val incomeSourceId: String = "123"
//  val foreignReportingMethodUrl: String = {
//    controllers.incomeSources.add.routes.IncomeSourceReportingMethodController.show(isAgent = false, ForeignProperty, incomeSourceId).url
//  }
//
