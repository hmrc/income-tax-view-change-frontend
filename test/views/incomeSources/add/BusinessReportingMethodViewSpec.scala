...
class BusinessReportingMethodViewSpec extends TestSupport {
  ...
  class Setup(isAgent: Boolean, error: Boolean = false) {
    ...
    val viewModelScenario1 = BusinessReportingMethodViewModel(Some(2022), Some(2023))
    val viewModelScenario2 = BusinessReportingMethodViewModel(None, Some(2023))


    //TODO: to be replaced with checkDetails page
    ...
    lazy val viewScenario1: HtmlFormat.Appendable = businessReportingMethodView(form, viewModelScenario1, postAction, isAgent, backUrl)
    lazy val viewScenario2: HtmlFormat.Appendable = businessReportingMethodView(form, viewModelScenario2, postAction, isAgent, backUrl)
    lazy val viewScenario1Error: HtmlFormat.Appendable = businessReportingMethodView(formWithErrorScenario1, viewModelScenario1, postAction, isAgent, backUrl)
    lazy val viewScenario2Error: HtmlFormat.Appendable = businessReportingMethodView(formWithErrorScenario2, viewModelScenario2, postAction, isAgent, backUrl)
  ...
  "BusinessReportingMethodView - Individual" when {
    "with static content" should {
      ...
      "render the content" in new Setup(false) {
        ...
        doc.getElementsByTag("p").get(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.description1", viewModelScenario1.taxYear2.get.toString)
    ...
    "render the back link with the correct URL" in new Setup(false) {
      documentScenario1.getElementById("back").text() shouldBe messages("base.back")
      documentScenario1.getElementById("back").attr("href") shouldBe backUrl
    }
    ...
    "taxYear1 and taxYear2 are present in Latency" should {
      "render the radio form" in new Setup(false) {
        ...
        doc.getElementsByTag("p").get(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario1.taxYear1.get - 1).toString, viewModelScenario1.taxYear1.get.toString)
        doc.getElementsByTag("p").get(1).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
      ...
      "render the radio form with input error" in new Setup(false, error = true) {
        val doc = documentScenario1.getElementById("add-business-reporting-method-form")
        doc.getElementsByTag("p").get(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario1.taxYear1.get - 1).toString, viewModelScenario1.taxYear1.get.toString)
        doc.getElementsByTag("p").get(2).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseAnnualReport")
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(1).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseQuarterlyReport")
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(2).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseAnnualReport")
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(3).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseQuarterlyReport")
        doc.getElementsByClass("govuk-radios").size() shouldBe 2
        doc.getElementById("tax_year_1_reporting-error").text() shouldBe messages("base.error-prefix") + " " + messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario1.taxYear1.get - 1).toString, viewModelScenario1.taxYear1.get.toString)
        doc.getElementById("tax_year_2_reporting-error").text() shouldBe messages("base.error-prefix") + " " + messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        ...
        documentScenario1.getElementsByClass("govuk-list govuk-error-summary__list").text() shouldBe {
          messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario1.taxYear1.get - 1).toString, viewModelScenario1.taxYear1.get.toString) + " " +
            messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        }
      }
    }
    "taxYear1 is crystallised and taxYear2 are present in Latency" should {
      "render the radio form" in new Setup(false) {
        ...
        doc.getElementsByTag("p").get(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario2.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseAnnualReport")
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(1).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseQuarterlyReport")
      ...
      "render the radio form with input error" in new Setup(false, error = true) {
        val doc = documentScenario2.getElementById("add-business-reporting-method-form")
        doc.getElementsByTag("p").get(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.taxYear", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(0).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseAnnualReport")
        doc.getElementsByClass("govuk-label govuk-radios__label").eq(1).text() shouldBe messages("incomeSources.add.businessReportingMethod.chooseQuarterlyReport")
        doc.getElementsByClass("govuk-radios").size() shouldBe 1
        doc.getElementById("tax_year_2_reporting-error").text() shouldBe messages("base.error-prefix") + " " + messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario1.taxYear2.get - 1).toString, viewModelScenario1.taxYear2.get.toString)
        ...
        documentScenario2.getElementsByClass("govuk-list govuk-error-summary__list").text() shouldBe {
          messages("incomeSources.add.businessReportingMethod.error", (viewModelScenario2.taxYear2.get - 1).toString, viewModelScenario2.taxYear2.get.toString)
        }
      }
    }
  }
