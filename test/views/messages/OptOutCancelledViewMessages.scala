...
object OptOutCancelledViewMessages {

  val titleIndividualContent = "Opt out cancelled - Manage your Income Tax updates - GOV.UK"
  ...
  val p2Content =
    "As you have one or more new businesses, you can choose to report annually for them for up to 2 tax years while still recording quarterly for your other businesses."
