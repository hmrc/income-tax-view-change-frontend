...
class HomePageViewSpec extends TestSupport {
  ...
  def testMtdItUser(saUtr: Option[String] = Some("testUtr")): MtdItUser[_] = {
    ...
    MtdItUser(
      ...
      IncomeSourceDetailsModel("nino", mtdbsa = testMtditid, yearOfMigration = yearOfMigrationOpt, businesses = Nil, properties = Nil),
      testNavHtml,
      saUtr,
      Some("testCredId"),
      Some(Individual),
  ...
  def testMtdItUserMigrated(saUtr: Option[String] = Some("testUtr")): MtdItUser[_] = MtdItUser(
    ...
    testNino,
    Some(testRetrievedUserName),
    IncomeSourceDetailsModel("nino", mtdbsa = testMtditid, yearOfMigration = Some("2018"), businesses = Nil, properties = Nil),
    testNavHtml,
    saUtr,
    Some("testCredId"),
    Some(Individual),
  ...
  def testMtdItUserNotMigrated(saUtr: Option[String] = Some("testUtr")): MtdItUser[_] = MtdItUser(
    ...
    testNino,
    Some(testRetrievedUserName),
    IncomeSourceDetailsModel("nino", mtdbsa = testMtditid, yearOfMigration = None, businesses = Nil, properties = Nil),
    testNavHtml,
    saUtr,
    Some("testCredId"),
    Some(Individual),
