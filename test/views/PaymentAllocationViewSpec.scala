...
class PaymentAllocationViewSpec extends ViewSpec with ImplicitDateFormatter {
  ...
  lazy val backUrl: String = financialDetailsRoutes.PaymentHistoryController.show().url
  ...
  val paymentAllocationTaxYearFrom2017to2018Hidden: String = messages("paymentAllocation.taxYearHidden", "2017", "2018")
  val paymentAllocationTaxYearFrom2018to2019Hidden: String = messages("paymentAllocation.taxYearHidden", "2018", "2019")
  ...
  "Payment Allocation Page" should {
    ...
    "have a fallback link" in new PaymentAllocationSetup {
      document.hasFallbackBacklinkTo(financialDetailsRoutes.PaymentHistoryController.show().url)
    }
    ...
    "have Payment allocations table" when {
      ...
      "a payment on account 1 of 2" in new PaymentAllocationSetup(viewModel(poa1Allocations: _*)) {
        ...
        val expectedLinkUrls: Seq[String] = Seq(
          financialDetailsRoutes.ChargeSummaryController.show(2018, "poa1_1").url,
          financialDetailsRoutes.ChargeSummaryController.show(2018, "poa1_2").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa1_3").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa1_4").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa1_5").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa1_6").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa1_7").url,
          financialDetailsRoutes.ChargeSummaryController.show(2020, "poa1_8").url,
        ...
        layoutContent.selectById("payment-allocation-table").text() shouldBe
          s"""
             ...
             |27 Jun 2019 $paymentAllocationsPoa1IncomeTax $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £1,234.56
             |28 Jun 2019 $paymentAllocationsPoa1IncomeTax $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £2,345.67
             |29 Jun 2019 $paymentAllocationsPoa1IncomeTax $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £3,456.78
             |30 Jun 2019 $paymentAllocationsPoa1IncomeTax $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £4,567.89
             |27 Aug 2019 $paymentAllocationsPoa1Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £9,876.54
             |28 Aug 2019 $paymentAllocationsPoa1Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £8,765.43
             |29 Aug 2019 $paymentAllocationsPoa1Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £7,654.32
             |30 Aug 2019 $paymentAllocationsPoa1Nic4 $paymentAllocationTaxYearFrom2019to2020Hidden $paymentAllocationTaxYearFrom2019to2020 £6,543.21
             |$dueDate $moneyOnAccountMessage $notApplicable £200.00
      ...
      "a payment on account 2 of 2" in new PaymentAllocationSetup(viewModel(poa2Allocations: _*)) {
        ...
        val expectedLinkUrls: Seq[String] = Seq(
          financialDetailsRoutes.ChargeSummaryController.show(2018, "poa2_1").url,
          financialDetailsRoutes.ChargeSummaryController.show(2018, "poa2_2").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa2_3").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa2_4").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa2_5").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa2_6").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "poa2_7").url,
          financialDetailsRoutes.ChargeSummaryController.show(2020, "poa2_8").url,
          financialDetailsRoutes.MoneyInYourAccountController.show().url
        )
        ...
        layoutContent.selectById("payment-allocation-table").text() shouldBe
          s"""
             |$allocationsTableHeadersText
             |27 Jun 2019 $paymentAllocationsPoa2IncomeTax $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £1,234.56
             |28 Jun 2019 $paymentAllocationsPoa2IncomeTax $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £2,345.67
             |29 Jun 2019 $paymentAllocationsPoa2IncomeTax $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £3,456.78
             |30 Jun 2019 $paymentAllocationsPoa2IncomeTax $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £4,567.89
             |27 Aug 2019 $paymentAllocationsPoa2Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £9,876.54
             |28 Aug 2019 $paymentAllocationsPoa2Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £8,765.43
             |29 Aug 2019 $paymentAllocationsPoa2Nic4 $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £7,654.32
             |30 Aug 2019 $paymentAllocationsPoa2Nic4 $paymentAllocationTaxYearFrom2019to2020Hidden $paymentAllocationTaxYearFrom2019to2020 £6,543.21
             |$dueDate $moneyOnAccountMessage $notApplicable £200.00
             |""".stripMargin.trim.linesIterator.mkString(" ")
      ...
      "a balancing charge" in new PaymentAllocationSetup(viewModel(bcdAllocations: _*)) {
        ...
        val expectedLinkUrls: Seq[String] = Seq(
          financialDetailsRoutes.ChargeSummaryController.show(2018, "bcd_1").url,
          financialDetailsRoutes.ChargeSummaryController.show(2018, "bcd_2").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "bcd_3").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "bcd_4").url,
          financialDetailsRoutes.ChargeSummaryController.show(2019, "bcd_5").url,
          financialDetailsRoutes.ChargeSummaryController.show(2020, "bcd_6").url,
          financialDetailsRoutes.MoneyInYourAccountController.show().url
        )
        ...
        layoutContent.selectById("payment-allocation-table").text() shouldBe
          s"""
             |$allocationsTableHeadersText
             |27 Jun 2019 ${messages("paymentAllocation.paymentAllocations.bcd.incomeTax")} $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £1,234.56
             |28 Jun 2019 ${messages("paymentAllocation.paymentAllocations.bcd.nic4")} $paymentAllocationTaxYearFrom2017to2018Hidden $paymentAllocationTaxYearFrom2017to2018 £2,345.67
             |29 Jun 2019 ${messages("paymentAllocation.paymentAllocations.bcd.nic2")} $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £3,456.78
             |27 Aug 2019 ${messages("paymentAllocation.paymentAllocations.bcd.cgt")} $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £9,876.54
             |28 Aug 2019 ${messages("paymentAllocation.paymentAllocations.bcd.sl")} $paymentAllocationTaxYearFrom2018to2019Hidden $paymentAllocationTaxYearFrom2018to2019 £8,765.43
             |29 Aug 2019 ${messages("paymentAllocation.paymentAllocations.bcd.vcnic2")} $paymentAllocationTaxYearFrom2019to2020Hidden $paymentAllocationTaxYearFrom2019to2020 £7,654.32
             |$dueDate $moneyOnAccountMessage $notApplicable £200.00
             |""".stripMargin.trim.linesIterator.mkString(" ")
    ...
    "The payments allocation view has Allocation Detail but no clearing date" should {
      "throw a MissingFieldException" in {
        val thrownException = intercept[MissingFieldException] {
          paymentAllocationView(paymentAllocationViewModelWithNoClearingAmount, backUrl, saUtr = None)
        }
