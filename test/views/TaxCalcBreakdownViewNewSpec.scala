...
abstract class TaxCalcBreakdownViewNewBehaviour extends ViewSpec {
  ...
  "The taxCalc breakdown view with Scotland tax regime" when {
    ...
    "provided with a calculation that is with Pay, pensions and profit table and with all three tax bands including " +
      ...
      lazy val view = taxCalcBreakdown(taxDueSummaryViewModel, taxYear, backUrl)
...
//
//        lazy val viewAllIncome = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
//
...
//        lazy val viewNoVoluntaryNic2Flag = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
//
//        lazy val viewAdChGiftAid = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
//
//        lazy val viewAdChPensionLumpSum = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
//
//        lazy val viewAdChPensionSavings = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
//
...
//          }
    ...
    ////			)))
    //
    //			lazy val view = taxCalcBreakdown(liabilityCalculationModelSuccessFull, taxYear, backUrl)
    //
