...
//      summaryListRowValues().eq(7).text() shouldBe "No"
  ...
  "Manage Uk Property - Individual" should {
    ...
    "render the whole page with unknowns and no change links" in new UkSetupUnknowns(false) {
      ...
      document.getElementById("standard-update-period-dropdown").text() shouldBe "What is a standard quarterly period? This business is reporting from 6th April in line with the tax year, also known as standard quarters. If your software supports it, you can change this to report from the 1st of the month by calendar quarters. Learn more about standard and calendar quarters (opens in new tab)"
      document.getElementById("expandable-standard-update-period").text() shouldBe "This business is reporting from 6th April in line with the tax year, also known as standard quarters."
      document.getElementById("software-support").text() shouldBe "If your software supports it, you can change this to report from the 1st of the month by calendar quarters."
