  ...
  "taxYearOverview" when {
    "the user is an individual" should {
      ...
      "display the income row in the Tax Calculation tab" in new Setup(estimateView()) {
        ...
        layoutContent.selectHead("#income-deductions-contributions-table tr:nth-child(1) td:nth-child(2)").text shouldBe completeOverview(false).income.toCurrencyString
      }
      ...
      "display the Total income on which tax is due row in the Tax Calculation tab" in new Setup(estimateView()) {
        ...
        layoutContent.selectHead("#income-deductions-contributions-table tr:nth-child(3) td:nth-child(2)").text shouldBe completeOverview(false).totalTaxableIncome.toCurrencyString
      }
      ...
      "display the Income Tax and National Insurance Contributions Due row in the Tax Calculation tab" in new Setup(estimateView()) {
        ...
        layoutContent.selectHead("#income-deductions-contributions-table tr:nth-child(4) td:nth-child(2)").text shouldBe completeOverview(false).taxDue.toCurrencyString
      }
