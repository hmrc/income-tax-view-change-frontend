...
class EnterClientsUTRViewSpec extends ViewSpec {
  ...
  def pageWithError(error: String = ClientsUTRForm.utrEmptyError): Html =
    enterClientsUTR(ClientsUTRForm.form.withError(ClientsUTRForm.utr, error), testCall)
