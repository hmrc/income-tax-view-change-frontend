...
class TaxYearOverviewViewSpec extends ViewSpec with FeatureSwitching {
  ...
  val testCharges: List[DocumentDetailWithDueDate] = List(
    ...
    DocumentDetailWithDueDate(DocumentDetail(taxYear = "2020", transactionId = "testId3", outstandingAmount = Some(100.00), originalAmount = Some(100.00), documentDescription = Some("TRM New Charge"), documentDate = "2018-03-29"), Some(LocalDate.of(2020, 4, 8)))
  )
