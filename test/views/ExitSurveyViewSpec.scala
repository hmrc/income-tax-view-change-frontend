  ...
  "The exit survey view" should {
    ...
    "not errored" should {
      ...
      lazy val page: HtmlFormat.Appendable =
        views.html.exit_survey.exit_survey(ExitSurveyForm.exitSurveyForm, controllers.routes.HomeController.home())(FakeRequest(), applicationMessages, mockAppConfig)
    ...
    "has errors" should {
      ...
      lazy val page: HtmlFormat.Appendable =
        views.html.exit_survey.exit_survey(form, controllers.routes.HomeController.home())(FakeRequest(), applicationMessages, mockAppConfig)
      lazy val document: Document = Jsoup.parse(contentAsString(page))
