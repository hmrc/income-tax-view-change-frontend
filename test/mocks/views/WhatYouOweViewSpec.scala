...
import financialDetails.controllers.routes.{ChargeSummaryController, MoneyInYourAccountController, PaymentController}
...
import _root_.financialDetails.models.outstandingCharges.OutstandingChargesModel
import _root_.financialDetails.models.{BalanceDetails, CodingOutDetails, DocumentDetail, FinancialDetailsModel, PoaTwoDebit, WhatYouOweChargesList, WhatYouOweViewModel}
import _root_.financialDetails.views.html.WhatYouOweView
    ...
    "The What you owe view with financial details model" when {
      "the user has charges and access viewer before 30 days of due date" should {
        ...
        "have penalty charges in table" in new TestSetup(whatYouOweAllPenalties, LPP2Url = appConfig.incomeTaxPenaltiesFrontendLPP2Calculation("chargeRefLPP2")) {
          ...
          lpp1Row.select("td").get(1).getElementsByClass("govuk-link").attr("href") shouldBe routes.ChargeSummaryController.show(fixedDate.getYear, id1040000123).url
          ...
          lspRow.select("td").get(1).getElementsByClass("govuk-link").attr("href") shouldBe routes.ChargeSummaryController.show(fixedDate.getYear, id1040000123).url
