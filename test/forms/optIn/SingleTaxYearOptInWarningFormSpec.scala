...
class SingleTaxYearOptInWarningFormSpec extends UnitSpec {
  ...
  val errorMessage: String = s"Select yes to opt out for the 2025 to 2026 tax year"
  ...
  when(mockMessages.apply(SingleTaxYearOptInWarningForm.noResponseErrorMessageKey, taxYear.startYear, taxYear.endYear))
