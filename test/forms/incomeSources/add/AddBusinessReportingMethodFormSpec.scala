...
class AddBusinessReportingMethodFormSpec extends TestSupport {

  lazy val form: Form[AddBusinessReportingMethodForm] = AddBusinessReportingMethodForm.form

  "AddBusinessReportingMethodForm" should {
