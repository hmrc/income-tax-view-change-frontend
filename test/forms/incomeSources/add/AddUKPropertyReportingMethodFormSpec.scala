...
class AddUKPropertyReportingMethodFormSpec extends TestSupport {

  lazy val form: Form[AddUKPropertyReportingMethodForm] = AddUKPropertyReportingMethodForm.form

  "AddUKPropertyReportingMethodForm" should {
