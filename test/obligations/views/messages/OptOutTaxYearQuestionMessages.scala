...
package obligations.views.messages
...
object OptOutTaxYearQuestionMessages {
  ...
  val currentYearDesc2Multi = "In future, you could be required to go back to using Making Tax Digital for Income Tax. If this happens, we will write to you to let you know."
  val currentYearQuestionMulti = "Do you want to opt out from the current tax year?"

  val currentYearHeadingSingleAnnualFollowing = "Opt out of Making Tax Digital for Income Tax for the 2025 to 2026 tax year"
  val currentYearTitleMultiAnnualFollowing= "Opt out of Making Tax Digital for Income Tax for the 2025 to 2026 tax year - Manage your Self Assessment - GOV.UK"
  val currentYearDesc1MultiAnnualFollowing = "From 6 April 2025 this would mean you do not need to use software compatible with Making Tax Digital for Income Tax, but you can keep using it if you prefer."
  val currentYearDesc2MultiAnnualFollowing = "In future, you could be required to go back to using Making Tax Digital for Income Tax. If this happens, we will write to you to let you know."
  ...
  val nextYearDesc1Multi = "From 6 April 2026 this would mean you do not need to use software compatible with Making Tax Digital for Income Tax, but you can keep using it if you prefer."
  val nextYearDesc2Multi = "In future, you could be required to go back to using Making Tax Digital for Income Tax. If this happens, we will write to you to let you know."
