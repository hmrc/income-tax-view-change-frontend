...
import obligations.services.reportingObligations.signUp
...
class SignUpSubmissionServiceSpec extends UnitSpec
  ...
  val mockSignUpSessionDataRepository: SignUpSessionDataRepository = mock(classOf[SignUpSessionDataRepository])
  ...
  val service: SignUpSubmissionService =
    new SignUpSubmissionService(
      ...
      repository = mockSignUpSessionDataRepository
    )
