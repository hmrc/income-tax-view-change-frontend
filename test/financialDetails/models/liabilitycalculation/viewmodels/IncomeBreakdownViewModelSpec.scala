...
import financialDetails.models.liabilitycalculation.Calculation
  ...
  "IncomeBreakdownViewModel model" when {
    ...
    "successful successModelFull" should {
      ...
      "create a full IncomeBreakdownViewModel when there is a full Calculation" in {
        ...
        IncomeBreakdownViewModel(Some(liabilityCalculationModelSuccessful.calculation.get)) shouldBe Some(expectedIncomeBreakdownViewModel)
      }
