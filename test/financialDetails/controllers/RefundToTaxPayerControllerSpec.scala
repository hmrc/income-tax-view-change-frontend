...
import financialDetails.controllers.RefundToTaxPayerController
        ...
        if (mtdUserRole == MTDSupportingAgent) {
          ...
          "redirect to the home page" when {
            "PaymentHistoryRefunds FS is disabled" in {
              ...
              val homeUrl = if (isAgent) controllers.routes.HomeController.showAgent() else controllers.routes.HomeController.show()
