...
import _root_.financialDetails.controllers.WhatYouOweController
...
import _root_.financialDetails.models.outstandingCharges.{OutstandingChargeModel, OutstandingChargesModel}
import _root_.financialDetails.models.{BalanceDetails, FinancialDetailsModel, WhatYouOweChargesList, WhatYouOweViewModel}
import _root_.financialDetails.services.WhatYouOweService
...
class WhatYouOweControllerSpec extends MockAuthActions
  ...
  def wyoViewModel(isAgent: Boolean,
    ...
    lpp2Url = LPP2Url,
    adjustPoaUrl = routes.AmendablePoaController.show(isAgent = isAgent).url,
