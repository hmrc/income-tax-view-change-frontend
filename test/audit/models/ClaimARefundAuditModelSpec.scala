...
class ClaimARefundAuditModelSpec extends AnyWordSpecLike {
  ...
  val balanceDetailsFull: BalanceDetails = BalanceDetails(balanceDueWithin30Days = 0, overDueAmount = 0, totalBalance = 0,
    totalCreditAvailableForRepayment = Some(-7600.00), allocatedCreditForOverdueCharges = Some(0), allocatedCreditForFutureCharges = Some(0), totalCredit = Some(2.00),
  ...
  val balanceDetailsMin: BalanceDetails = BalanceDetails(balanceDueWithin30Days = 0, overDueAmount = 0, totalBalance = 0,
    totalCreditAvailableForRepayment = None, allocatedCreditForOverdueCharges = None, allocatedCreditForFutureCharges = None, totalCredit = None, firstPendingAmountRequested = None, secondPendingAmountRequested = None, None)
